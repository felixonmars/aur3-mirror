...
# nginx-slowfs PKGBUILD:
# Vadym Abramchuk <abramm@gmail.com>

_cfgdir=/etc/nginx
_tmpdir=/var/lib/nginx

pkgname=nginx-slowfs
pkgver=1.2.3
pkgrel=1
pkgdesc="nginx HTTP server with slowfs module"
arch=('i686' 'x86_64')
...
build() {
	...
	./configure \
        ...
        --add-module=$srcdir/ngx_slowfs_cache-1.9 \
