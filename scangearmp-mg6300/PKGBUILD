...
arch=('i686' 'x86_64')
license=('custom')
depends=('gtk2' 'sane' 'libpng>=1.5')
makedepends=('gimp')
install=scangearmp-mg6300.install
source=(http://gdlp01.c-wss.com/gds/8/0100004708/01/scangearmp-source-${_pkgver}.tar.gz
  'libpng15.patch'
  'fix_configure.patch')
...
package() {
  ...
  # Install udev rules
  install -D -m 0644 ${srcdir}/scangearmp-source-${_pkgver}/scangearmp/etc/80-canon_mfp.rules ${pkgdir}/usr/lib/udev/rules.d/80-canon_mfp.rules
