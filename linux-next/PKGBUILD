...
makedepends=(git bc)
options=(!strip)
source=($pkgname::git://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git
        config.{i686,x86_64})
md5sums=('SKIP'
         '12b1c9f415adb9b4893436607572b7cf'
         'ac829da040d0d3fc4ae7ad58103c5273')
sha256sums=('SKIP'
            'bc20478bc147a7bdc40fd99866d99c21cb4e21c71a524fe245b426b7eef507ce'
            '4c18387fa5346f426c1d224f9ba87557bd1580db9db8badf2174137db0b793ab')
