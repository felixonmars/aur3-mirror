...
# see from https://aur.archlinux.org/packages/jre7-openjdk-headless-fontfix/
...
pkgname=jre7-openjdk-headless-fontfix-pschyska
_java_ver=7
_icedtea_ver=2.4.3
...
#        jdk7-openjdk.profile.csh
        jre7-openjdk-fontfix-pschyska.profile
        jre7-openjdk-fontfix-pschyska.profile.csh)
...
package() {
  ...
  install -m755 ${srcdir}/jre7-openjdk-fontfix-pschyska.profile ${pkgdir}/etc/profile.d/jre.sh
  install -m755 ${srcdir}/jre7-openjdk-fontfix-pschyska.profile.csh ${pkgdir}/etc/profile.d/jre.csh
