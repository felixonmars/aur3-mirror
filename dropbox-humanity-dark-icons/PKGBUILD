...
pkgname=dropbox-humanity-dark-icons
pkgver=1.1
pkgrel=10
pkgdesc="Notification icons for Dropbox matching the Humanity Dark theme."
arch=(any)
url=https://forums.dropbox.com/topic.php?id=7818
license=(CCPL:by-3.0)
depends=(dropbox hicolor-icon-theme)
conflicts=(dropbox-{{light,dark}-panel,humanity}-icons)
...
package() {
    cd "$srcdir"/Dropbox\ Humanity\ Notification\ Icons/Humanity-Dark/icons/
    for i in *.png; do
