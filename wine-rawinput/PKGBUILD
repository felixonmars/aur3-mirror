...
source=(http://prdownloads.sourceforge.net/$_pkgbasename/$_pkgbasename-$_pkgbasever.tar.bz2 rawinput3.patch)
md5sums=('930485c8df59edcf0a6e3fd87cca8b39' 
'b68cad68f5cd75241e5c89b25114cf6e')

pkgdesc="A compatibility layer for running Windows programs with the rawinput patch"
...
build() {
  ...
  # Apply rawinput patch
  cd ${_pkgbasename}
  patch -p1 < ${srcdir}/rawinput3.patch
  ./tools/make_requests
  cd ..
