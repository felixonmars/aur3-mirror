...
options=('!libtool')
source=(
    "http://curl.haxx.se/download/${_pkgbase}-${pkgver}.tar.gz"
    'curlbuild-stub.h'
)
md5sums=('cbdc0a79bdf6e657dd387c3d88d802e3'
         '62f635029116994eb9b4d32cd8ef45d6')
...
package() {
  ...
  install -Dm644 "${srcdir}/curlbuild-stub.h" "${pkgdir}/usr/include/curl/curlbuild-stub.h"
