...
pkgname=xcursor-gt3-light
pkgver=1.0
pkgrel=1
pkgdesc="GT3 light cursor theme."
arch=(i686 x86_64)
...
build() {
	...
	install -d -m755 $startdir/pkg/usr/share/icons/GT3-light/cursors
	tar xf GT3-light.tar.gz
	cd $startdir/src/GT3cursors/GT3-light/cursors
	for i in * ; do
		install -D -m644 $i $startdir/pkg/usr/share/icons/GT3-light/cursors
	done
}