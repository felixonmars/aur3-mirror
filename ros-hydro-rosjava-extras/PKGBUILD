...
pkgname='ros-hydro-rosjava-extras'
pkgver='0.1.5'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
_tag=release/hydro/rosjava_extras/${pkgver}-${_pkgver_patch}
_dir=rosjava_extras
source=("${_dir}"::"git+https://github.com/rosjava-release/rosjava_extras-release.git"#tag=${_tag})
md5sums=('SKIP')
