...
typedef struct DisplayParams
{
	...
	static const int DEFAULT_PAGE_RX = 1584;		/**< Default A4 width on a device with 72 horizontal dpi. */
	static const int DEFAULT_PAGE_RY = 1584;		/**< Default A4 height on a device with 72 vertical dpi. */
