...
pkgbase=linux-joggler
pkgname=linux-joggler
#pkgname=(linux-joggler linux-joggler-headers)
...
build() {
  ...
  patch -Np1 -i "${srcdir}/joggler-backlight-control-3.2.patch"
  patch -Np1 -i "${srcdir}/joggler-sound-3.2.patch"
  patch -Np1 -i "${srcdir}/joggler-i2c-3.2.patch"
...
package_linux-joggler() {
  pkgdesc="The Linux Kernel and modules"
  groups=('base')
  depends=('coreutils' 'linux-firmware' 'kmod' 'mkinitcpio>=0.7')
  optdepends=('crda: to set the correct wireless channels of your country')
  provides=("linux-joggler-headers=${pkgver}")
  ...
  ln -sf ../../../usr/src/linux-${pkgver}-${pkgrel}-ARCH build
}

package_linux-joggler-headers() {
...
md5sums=('7133f5a2086a7d7ef97abac610c094f5'
         ...
         '7933d351415e5b765ddf411b093092dc'
	 ...
	 '0bf4ed77ad915ecae5daf3c6ca0f6578'
	 'c7563db8320b3ae7133d701752bffedf'
	 '20ec5d428ad4e757e757f0ecaab02db4')
