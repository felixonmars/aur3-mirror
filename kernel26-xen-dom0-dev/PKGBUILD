...
source=(ftp://ftp.kernel.org/pub/linux/kernel/v2.6/linux-${pkgver}.tar.bz2 config.xen config.xen.x86_64 config config.x86_64 ${pkgname}.preset http://gentoo-xen-kernel.googlecode.com/files/xen-patches-2.6.34-1.tar.bz2 microcode_core-xen.patch)
...
md5sums=('10eebcb0178fb4540e2165bfd7efc7ad'
         ...
         '7dd76b27ea4e06a7e5b18a0320188d70'
         '292e19d1f3cae0d9a68533a36be4bc4e'
