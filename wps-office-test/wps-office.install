...
function whisperer(){
    ...
    echo "http://linux.wps.cn/"
    echo "----------------------------------------------------------------"
    echo ""
    echo "----------------------------------------------------------------"
    echo "WPS Office (an office productivity suite for Linux)"
    echo "WPS Office, including Writer, Presentation and spreadsheets, is a"
    echo "powerful office suite. It is deeply compatible with all of the"
    echo "latest Microsoft Office file formats. It can easily open and read"
    echo "the documents created with Microsoft Office."
    echo ""
