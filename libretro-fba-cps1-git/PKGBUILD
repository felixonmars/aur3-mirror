...
pkgver=798.7e70ddf
pkgrel=1
pkgdesc="libretro implementation of Final Burn Alpha's CPS1 core (FBA). (CP System I)"
arch=('i686' 'x86_64' 'arm' 'armv6h')
url="https://github.com/libretro/fba-libretro"
license=('custom:FB Alpha License')
makedepends=('git')

_libname=fba_cores_cps1_libretro
...
package() {
  ...
  install -Dm644 "${_gitname}/svn-current/trunk/fbacores/cps1/${_libname}.so" "${pkgdir}/usr/lib/libretro/${_libname}.so"
