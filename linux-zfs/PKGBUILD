# Contributor: Ariel Ladegard <legendin@gmail.com>
# Maintainer: Tobias Powalowski <tpowa@archlinux.org>
# Maintainer: Thomas Baechler <thomas@archlinux.org>

pkgbase=linux-zfs
# AUR split-package workaround...
pkgname="linux-zfs"
true && pkgname=('linux-zfs' 'linux-zfs-headers') # Build zfs kernel
...
md5sums=('7133f5a2086a7d7ef97abac610c094f5'
         ...
         '974dad8ba41dc6ba540d65219fd4c286'
         '644b839b4df246acabd7ce0693e9cb62'
...
package_linux-zfs() {
  pkgdesc="The Linux Kernel and modules configured for zfsonlinux"
  groups=('base')
...
package_linux-zfs-headers() {
  true && pkgdesc="Header files and scripts for building modules for linux-zfs kernel"
