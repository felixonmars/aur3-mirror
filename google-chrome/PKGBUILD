...
pkgver=25.0.1364.172   # Check for new Linux releases in: http://googlechromereleases.blogspot.com/search/label/Stable%20updates
pkgrel=1
...
_channel='stable'
_verbld=25.0.1364.172-187217

if [ "$CARCH" = "i686" ]; then
    _arch='i386'
    md5sums=('68bacc0d36176051a96b2f3687f82248')
elif [ "$CARCH" = "x86_64" ]; then
    _arch='x86_64'
    md5sums=('b13be4231abb19894b96b357aaa264f0')
fi
