...
pkgname=wacom-next-linux-git
pkgver=20120924
pkgrel=2
pkgdesc="Kernel drivers for Wacom tablets, next branch"
arch=('i686' 'x86_64')
...
conflicts=('linuxwacom-cvs' 'input-wacom' 'input-wacom-cvs' 'linuxwacom-baboo-cth-ctl'
           'wacom-mainline-linux-git' 'wacom-linux-git')
source=("fix.patch")
md5sums=('b8d4538bb3a0002c72dca1252aa7363b')

install=wacom-next-linux-git.install

_gitrepo="linux/kernel/git/next"
_gitname="linux-next.git"
