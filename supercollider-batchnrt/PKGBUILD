...
pkgname=supercollider-batchnrt
pkgdesc="SuperCollider quark: A method for batch-processing audio files in NRT mode Author: Dan Stowell."
_quark="batchNRT"
_path=NonRT/batchNRT
depends=('supercollider' 'supercollider-processtools')
