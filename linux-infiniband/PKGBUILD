...
pkgname=linux-infiniband
pkgbase=linux-infiniband       # Build kernel with a different name
_srcname=linux-3.13
pkgver=3.13.7
pkgrel=1
arch=('i686' 'x86_64')
...
md5sums=('0ecbaf65c00374eb4a826c2f9f37606f'
         ...
         '0055d3ef4d47618630d3a8b27d2dad42'
         '33f6c014c06c50000a114870929781a8'
...
package() {
  pkgdesc="The Linux kernel and modules with InfiniBand drivers and headers"
