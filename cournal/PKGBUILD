...
# Maintainer: Fabian Henze <flyser42@gmx.de>
...
depends=('python>=3.1' 'gtk3>=3.2' 'poppler-glib>=0.18' 'gobject-introspection' 'python-gobject' 'python-zope-interface>=3.6' 'hicolor-icon-theme' 'desktop-file-utils')
