...
pkgname='ros-hydro-rosbridge-suite'
pkgver='0.5.1'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
ros_depends=(ros-hydro-rosapi
  ros-hydro-rosbridge-library
  ros-hydro-rosbridge-server)
depends=(${ros_depends[@]})

_tag=release/hydro/rosbridge_suite/${pkgver}-${_pkgver_patch}
_dir=rosbridge_suite
