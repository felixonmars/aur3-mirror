...
pkgname='ros-hydro-ros-controllers'
pkgver='0.6.0'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
ros_depends=(ros-hydro-velocity-controllers
  ros-hydro-force-torque-sensor-controller
  ros-hydro-effort-controllers
  ros-hydro-forward-command-controller
  ros-hydro-joint-trajectory-controller
  ros-hydro-position-controllers
  ros-hydro-imu-sensor-controller
  ros-hydro-joint-state-controller)
depends=(${ros_depends[@]})

_tag=release/hydro/ros_controllers/${pkgver}-${_pkgver_patch}
