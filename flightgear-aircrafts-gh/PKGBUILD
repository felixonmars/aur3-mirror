...
pkgname=flightgear-aircrafts-gh
pkgver=3.0
pkgrel=1
pkgdesc="Aircraft collection for Flightgear - Name beginning with letter G and H."
...
package() {
  ...
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/g*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/G*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/h*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/H*'	#get and unzip the aircrafts
