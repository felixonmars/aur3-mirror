...
pkgver=42
pkgrel=1
pkgdesc="Map of Yaroslavl for 2GIS, December 2013"
arch=('i686' 'x86_64')
url="http://yaroslavl.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.11.0')
source=("http://download.2gis.ru/arhives/2GISData_Yaroslavl-42.orig.zip")
md5sums=('79e27b5c9e23e8f2ebe5d9bd3cb15bd1')
