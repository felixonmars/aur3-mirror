...
pkgver=37
pkgrel=1
pkgdesc="Map of Yaroslavl for 2GIS, July 2013"
arch=('i686' 'x86_64')
url="http://yaroslavl.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.5.1')
source=("http://download.2gis.ru/arhives/2GISData_Yaroslavl-37.orig.zip")
md5sums=('4b49ce08a83ef777326fded17713fbf6')
