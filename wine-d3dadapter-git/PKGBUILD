...
pkgname=wine-d3dadapter-git
pkgver=1.7.37.104137
pkgrel=1
...
source=("$pkgname"::'git+https://github.com/iXit/wine.git'
...
pkgver() {
  cd "$srcdir/$pkgname"
  echo $(cat VERSION | tr "-" "_" | grep -oP '[\d.]+').$(git rev-list --count HEAD)
}
