...
package() {
  ...
  install -D autoload/ghcmod/command.vim  ${pkgdir}/usr/share/vim/vimfiles/autoload/ghcmod/command.vim
  install -D autoload/ghcmod/type.vim  ${pkgdir}/usr/share/vim/vimfiles/autoload/ghcmod/type.vim
  install -D autoload/ghcmod/util.vim  ${pkgdir}/usr/share/vim/vimfiles/autoload/ghcmod/util.vim
