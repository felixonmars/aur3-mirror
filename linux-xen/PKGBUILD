...
pkgbase=linux-xen
pkgname=('linux-xen') # Build stock -ARCH kernel with Xen guest support
...
md5sums=('7133f5a2086a7d7ef97abac610c094f5'
         ...
         'f24c788d73dcae5f053a61ed161f7345'
         'f8708d091c8796a32e16ac3f5091797f'
...
package_linux-xen() {
  pkgdesc="The Linux Kernel and modules with Xen guest support"
  depends=('coreutils' 'linux-firmware' 'module-init-tools>=3.16' 'mkinitcpio>=0.7')
  optdepends=('crda: to set the correct wireless channels of your country')
  provides=('linux' 'kernel26')
  conflicts=('kernel26')
  replaces=('kernel26')
