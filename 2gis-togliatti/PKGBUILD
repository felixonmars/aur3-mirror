...
pkgver=61
pkgrel=1
pkgdesc="Map of Togliatti for 2GIS, August 2013"
arch=('i686' 'x86_64')
url="http://tlt.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.5.1')
source=("http://download.2gis.ru/arhives/2GISData_Togliatti-61.orig.zip")
md5sums=('d210290e88c440987d99bc65f5a0ed27')
