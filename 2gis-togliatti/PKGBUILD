...
pkgver=50
pkgrel=1
pkgdesc="Map of Togliatti for 2GIS, September 2012"
arch=('i686' 'x86_64')
url="http://tlt.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.9.0.1')
source=("http://download.2gis.ru/arhives/2GISData_Togliatti-50.orig.zip")
md5sums=('d826ff73662a84af09b500d590843af3')
