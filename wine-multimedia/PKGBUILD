...
_multimediasnapshot=20150220

source=(http://prdownloads.sourceforge.net/$_basename/$_basename-$_pkgbasever.tar.bz2
        30-win32-aliases.conf
        winemultimedia_${pkgver}_${_multimediasnapshot}.patch)

sha1sums=('351118b5969dca91d3fd019f703fa2754bde4f50'
          '023a5c901c6a091c56e76b6a62d141d87cce9fdb'
          'b1219570724d2a7f59962065b8879b6d4ae33427')
...
#
#  source[${#source[@]}]="http://prdownloads.sourceforge.net/$_basename/$_basename-$_pkgbasever.tar.bz2.sign"
