...
pkgbase=linux-groovy
pkgdesc="Linux kernel patched to allow 15KHz operation for arcade/PAL/NTSC monitors"
_srcname=linux-3.17
pkgver=3.17.6
pkgrel=1
arch=('i686' 'x86_64')
...
sha256sums=('f5153ec93c5fcd41b247950e6a9bcbc63fa87beafd112c133a622439a0f76251'
            ...
            'fb27542a749598214c66a7309853cadc94257d8385e4c9db50755083b8486950'
            'a2e888b5f9f243e2c24209c1c87374cab1ff039ba0511f1ca274cd50421d4790'
            'ed7d2445d3117ff6a4b6aa1c349efec067818696ef259970ba41e7330801d8f5')
...
prepare() {
  ...
  # patches from Ansa89 for arcade monitors  
  patch -p1 -i "${srcdir}/ati9200_pllfix-3.17.diff"
  patch -p1 -i "${srcdir}/avga3000-3.17.diff"
  patch -p1 -i "${srcdir}/linux-3.17.diff"
