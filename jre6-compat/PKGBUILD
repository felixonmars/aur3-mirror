...
[ "${CARCH}" == 'x86_64' ] && _arch=x64 && source[0]="http://download.oracle.com/otn-pub/java/jdk/${pkgver}-b${_pkgrel}/jdk-${pkgver}-linux-x64.bin" && md5sums[0]='40c1a87563c5c6a90a0ed6994615befe'
