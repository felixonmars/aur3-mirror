...
_pkgbasename=nvidia-utils-ll
pkgname=lib32-$_pkgbasename
pkgver=295.59
pkgrel=1
pkgdesc="NVIDIA drivers utilities and libraries (32-bit) (long-lived branch)"
arch=('x86_64')
url="http://www.nvidia.com/"
depends=('lib32-libxvmc' 'lib32-zlib' 'lib32-gcc-libs' $_pkgbasename)
conflicts=('lib32-libgl' 'nvidia-utils')
provides=('lib32-libgl' 'nvidia-utils')
license=('custom')
options=('!strip')
