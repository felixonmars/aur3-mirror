...
pkgname=broadcom-wl-lqx
pkgver=6.30.223.248
pkgrel=9
_pkgdesc='Broadcom 802.11abgn hybrid Linux networking device driver for linux-lqx.'
...
install=broadcom-wl-lqx.install
...
package() {
	...
	install -Dm644 modprobe.d "${pkgdir}/usr/lib/modprobe.d/broadcom-wl_lqx.conf"
}
