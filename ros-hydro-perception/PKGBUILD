...
pkgdesc="ROS - perception metapackage."
url='http://www.ros.org/'

pkgname='ros-hydro-perception'
pkgver='1.0.2'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
ros_depends=(ros-hydro-image-pipeline
  ros-hydro-image-common
  ros-hydro-vision-opencv
  ros-hydro-perception-pcl
  ros-hydro-laser-pipeline
  ros-hydro-image-transport-plugins)
depends=(${ros_depends[@]})

_tag=release/hydro/perception/${pkgver}-${_pkgver_patch}
_dir=perception
