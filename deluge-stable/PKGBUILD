...
_gitroot="git://deluge-torrent.org/deluge.git#branch=1.3-stable"

#pkgver() {
#  cd "${srcdir}/${_gitname}"
#  git describe --long --always | sed 's/deluge-//;s/-/./g'
## for pacman 4.1
#}
