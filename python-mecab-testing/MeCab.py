...
class Lattice(_object):
    ...
    def is_available(self) -> "bool" : return _MeCab.Lattice_is_available(self)
    def bos_node(self) -> "MeCab::Node *" : return _MeCab.Lattice_bos_node(self)
    def eos_node(self) -> "MeCab::Node *" : return _MeCab.Lattice_eos_node(self)
    def end_nodes(self, *args) -> "MeCab::Node *" : return _MeCab.Lattice_end_nodes(self, *args)
    def begin_nodes(self, *args) -> "MeCab::Node *" : return _MeCab.Lattice_begin_nodes(self, *args)
    def sentence(self) -> "char const *" : return _MeCab.Lattice_sentence(self)
    def size(self) -> "size_t" : return _MeCab.Lattice_size(self)
    def set_Z(self, *args) -> "void" : return _MeCab.Lattice_set_Z(self, *args)
    def Z(self) -> "double" : return _MeCab.Lattice_Z(self)
    def set_theta(self, *args) -> "void" : return _MeCab.Lattice_set_theta(self, *args)
    def theta(self) -> "float" : return _MeCab.Lattice_theta(self)
    def next(self) -> "bool" : return _MeCab.Lattice_next(self)
    def request_type(self) -> "int" : return _MeCab.Lattice_request_type(self)
    def has_request_type(self, *args) -> "bool" : return _MeCab.Lattice_has_request_type(self, *args)
    def set_request_type(self, *args) -> "void" : return _MeCab.Lattice_set_request_type(self, *args)
    def add_request_type(self, *args) -> "void" : return _MeCab.Lattice_add_request_type(self, *args)
    def remove_request_type(self, *args) -> "void" : return _MeCab.Lattice_remove_request_type(self, *args)
    def toString(self, *args) -> "char const *" : return _MeCab.Lattice_toString(self, *args)
    def enumNBestAsString(self, *args) -> "char const *" : return _MeCab.Lattice_enumNBestAsString(self, *args)
    def what(self) -> "char const *" : return _MeCab.Lattice_what(self)
    def set_what(self, *args) -> "void" : return _MeCab.Lattice_set_what(self, *args)
    ...
    def set_sentence(self, *args) -> "void" : return _MeCab.Lattice_set_sentence(self, *args)
...
class Model(_object):
    ...
    __repr__ = _swig_repr
    def dictionary_info(self) -> "MeCab::DictionaryInfo const *" : return _MeCab.Model_dictionary_info(self)
    def createTagger(self) -> "MeCab::Tagger *" : return _MeCab.Model_createTagger(self)
    def createLattice(self) -> "MeCab::Lattice *" : return _MeCab.Model_createLattice(self)
    def swap(self, *args) -> "bool" : return _MeCab.Model_swap(self, *args)
...
def Model_version() -> "char const *" :
  return _MeCab.Model_version()
Model_version = _MeCab.Model_version

def Model_create(*args) -> "MeCab::Model *" :
...
class Tagger(_object):
    ...
    __repr__ = _swig_repr
    def parse(self, *args) -> "char const *" : return _MeCab.Tagger_parse(self, *args)
    def parseToNode(self, *args) -> "MeCab::Node const *" : return _MeCab.Tagger_parseToNode(self, *args)
    def parseNBest(self, *args) -> "char const *" : return _MeCab.Tagger_parseNBest(self, *args)
    def parseNBestInit(self, *args) -> "bool" : return _MeCab.Tagger_parseNBestInit(self, *args)
    def nextNode(self) -> "MeCab::Node const *" : return _MeCab.Tagger_nextNode(self)
    def next(self) -> "char const *" : return _MeCab.Tagger_next(self)
    def formatNode(self, *args) -> "char const *" : return _MeCab.Tagger_formatNode(self, *args)
    def set_request_type(self, *args) -> "void" : return _MeCab.Tagger_set_request_type(self, *args)
    def request_type(self) -> "int" : return _MeCab.Tagger_request_type(self)
    def partial(self) -> "bool" : return _MeCab.Tagger_partial(self)
    def set_partial(self, *args) -> "void" : return _MeCab.Tagger_set_partial(self, *args)
    def lattice_level(self) -> "int" : return _MeCab.Tagger_lattice_level(self)
    def set_lattice_level(self, *args) -> "void" : return _MeCab.Tagger_set_lattice_level(self, *args)
    def all_morphs(self) -> "bool" : return _MeCab.Tagger_all_morphs(self)
    def set_all_morphs(self, *args) -> "void" : return _MeCab.Tagger_set_all_morphs(self, *args)
    def set_theta(self, *args) -> "void" : return _MeCab.Tagger_set_theta(self, *args)
    def theta(self) -> "float" : return _MeCab.Tagger_theta(self)
    def dictionary_info(self) -> "MeCab::DictionaryInfo const *" : return _MeCab.Tagger_dictionary_info(self)
    def what(self) -> "char const *" : return _MeCab.Tagger_what(self)
    ...
    def parseToString(self, *args) -> "char const *" : return _MeCab.Tagger_parseToString(self, *args)
Tagger_swigregister = _MeCab.Tagger_swigregister
Tagger_swigregister(Tagger)

def Tagger_create(*args) -> "MeCab::Tagger *" :
  return _MeCab.Tagger_create(*args)
Tagger_create = _MeCab.Tagger_create

def Tagger_version() -> "char const *" :
