...
source=( https://launchpad.net/~wfg/+archive/0ad/+files/0ad_0.0.0%2Br08832-1~10.10~wfg1_$_arch.deb https://launchpad.net/~wfg/+archive/0ad/+files/0ad-data_0.0.0%2Br08832-1~10.10~wfg1_all.deb http://trac.wildfiregames.com/attachment/ticket/492/0ad.packaging.tar.gz?format=raw 0ad.sh http://ubuntu.mirror.cambrium.nl/ubuntu//pool/universe/b/boost1.40/libboost-filesystem1.40.0_1.40.0-6ubuntu1_$_arch.deb http://ubuntu.mirror.cambrium.nl/ubuntu//pool/universe/b/boost1.40/libboost-system1.40.0_1.40.0-6ubuntu1_$_arch.deb)
md5sums=(  36f8e02ae3daf81114eb207dd789c41a fe27ed6aff7752ca76fc88fd199f683a b6c74d2ee0fa4b54b7e617c25794ca3e 9677c33dddf6e20c16f042ae0621082c d685a2421f7e070df57c6b1624a25455 4c34d6a96877b6d79d4cb6d99d805826 )
[ $CARCH == i686 ] && md5sums=( 38b0897f4f6514c9fc2cd10d77205629 fe27ed6aff7752ca76fc88fd199f683a b6c74d2ee0fa4b54b7e617c25794ca3e 9677c33dddf6e20c16f042ae0621082c c516c0edfd025a0925baf2ae6b44790e eb948da264a58a7d6282cce37f9d67ff )
...
build() {
  ...
  7z e 0ad_0.0.0%2Br08832-1~10.10~wfg1_amd64.deb -so |tar -x
  7z e 0ad-data_0.0.0%2Br08832-1~10.10~wfg1_all.deb -so |tar -x
  mv usr $pkgdir/
 
  # Unpack and install libfix
  deb2targz libboost-filesystem1.40.0_1.40.0-6ubuntu1_amd64.deb
  tar -xzf libboost-filesystem1.40.0_1.40.0-6ubuntu1_amd64.tar.gz
  deb2targz libboost-system1.40.0_1.40.0-6ubuntu1_amd64.deb
  tar -xzf libboost-system1.40.0_1.40.0-6ubuntu1_amd64.tar.gz
