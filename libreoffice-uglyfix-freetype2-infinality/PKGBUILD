...
pkgname=libreoffice-uglyfix-freetype2-infinality
pkgver=2.4.6
pkgrel=1
pkgdesc="Compiles freetype2 .so files and puts them in the libreoffice directory to fix font ugliness"
arch=(i686 x86_64)
license=('GPL')
...
build() {
  ...
  # Defining installation directory of libreoffice:
	INSTDIR=libreoffice/basis3.4
