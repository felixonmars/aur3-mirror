...
pkgdesc="ROS - Synchronize the local ROS master to the remote masters discovered by master_discovery_fkie node."
url='http://ros.org/wiki/master_sync_fkie'

pkgname='ros-hydro-master-sync-fkie'
pkgver='0.3.10'
_pkgver_patch=0
arch=('any')
pkgrel=1
...
_tag=release/hydro/master_sync_fkie/${pkgver}-${_pkgver_patch}
