...
pkgname=brother-mfc9840cdw-lpr
_printer=mfc9840cdw
pkgver=1.0.2_4
pkgrel=1
pkgdesc="LPR driver for Brother MFC-9840CDW multifunction network printer"
arch=('i686' 'x86_64')
...
conflicts=("$pkgname")
replaces=("$pkgname")
source=('http://solutions.brother.com/Library/sol/printer/linux/dlf/mfc9840cdwlpr-1.0.2-4.i386.deb'
        'license.txt')
