...
c/curl/libcurl3_7.21.6-3ubuntu3.2,\
...
sha256sums=('02181c11384726dad7c871144da95410df63cd36d5e60596d5f04999faff68bf'
    'fc9d33e2edfff1b50607a9e2b825658167d477e0730ac09a5d1b42e72b8c4027'
...
sha512sums=('7036f2b984fa183229edd25a6299e5e612a4de7fb3debb39dc5f1995a27dbc024dfb1fc5ec2bc5d12d223b86de5b9006d3ae4cfbce4deb3c7770a4236203f832'
    'b1705f08dd098bba600d6cfc33d425d340275ed0864429e3865a1c9af0269bc2265562b7bfda0060c151a591de68db1445292540eef4ed3b2d15c3f276136c0e'
...
package() {
    ...
    cd "$pkgdir"/usr/
    sed -i 's/0.9.8/1.0.0/' bin/$pkgname
    rm -rf lib/i386-linux-gnu share/xml
    ln -s libcurl.so.4 lib/libcurl.so.3
    [[ $CARCH == "x86_64" ]] && mv lib lib32
}
