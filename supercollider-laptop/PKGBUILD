...
pkgname=supercollider-laptop
pkgdesc="SuperCollider quark: A set of classes to interface laptop internals. Author: Marije Baalman."
_quark="Laptop"
_path=Laptop
depends=('supercollider' 'supercollider-senseworlddatanetwork')
