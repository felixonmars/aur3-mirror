...
pkgname='ros-hydro-rocon-gateway'
pkgver='0.6.2'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
ros_depends=(ros-hydro-redis
  ros-hydro-rospy
  ros-hydro-rocon-hub-client
  ros-hydro-rostopic
  ros-hydro-rosservice
  ros-hydro-gateway-msgs
  ros-hydro-zeroconf-msgs
  ros-hydro-roslib
  ros-hydro-rocon-utilities)
depends=(${ros_depends[@]})

_tag=release/hydro/rocon_gateway/${pkgver}-${_pkgver_patch}
_dir=rocon_gateway
