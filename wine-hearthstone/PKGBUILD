# $Id: PKGBUILD 113699 2014-06-28 09:23:06Z svenstaro $
# Maintainer: Sven-Hendrik Haase <sh@lutzhaase.com>
# Contributor: Jan "heftig" Steffens <jan.steffens@gmail.com>
# Contributor: Eduardo Romero <eduardo@archlinux.org>
# Contributor: Giovanni Scafora <giovanni@archlinux.org>
# Contributor: Tommy Suaer <sauer@b1-systems.de>

pkgname=wine-hearthstone
_pkgname=wine
pkgver=1.7.21
pkgrel=3
...
source=(http://prdownloads.sourceforge.net/$_pkgname/$_pkgname-$_pkgbasever.tar.bz2{,.sign}
        ...
        hearthstone.patch::http://bugs.winehq.org/attachment.cgi?id=48575)
sha1sums=('eb3b2eb8e1cfd30324b643c33f34f25bf5aaa451'
          'SKIP'
          '023a5c901c6a091c56e76b6a62d141d87cce9fdb'
          '31350e6a31a8717bb4f7dfc4a07818b72e04c03a')

pkgdesc="Originally Arch wine patched to have hearthstone working"
...
build() {
  ...
  #hearthstone patch
  cd $srcdir/$_pkgname
  patch -p1 < $srcdir/hearthstone.patch 
  cd $srcdir
