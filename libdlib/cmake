# this file is written for libdlib package
#
    ...
    if (NOT DLIB_ISO_CPP_ONLY)
        ...
        if (NOT DLIB_NO_GUI_SUPPORT)
            ...
            if (X11_FOUND)
                ...
                set (dlib_needed_libraries "${dlib_needed_libraries} -lX11 ")
            else()
                message(" *****************************************************************************")
