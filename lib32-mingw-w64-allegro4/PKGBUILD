pkgname=lib32-mingw-w64-allegro4
pkgver=4.4.2
pkgrel=1
pkgdesc="Portable library mainly aimed at video game and multimedia programming (legacy version) (mingw-w64, 32-bit)"
arch=(any)
url="http://alleg.sourceforge.net"
license=("custom")
makedepends=(mingw-w64-gcc cmake)
depends=(mingw-w64-crt)
conflicts=(mingw-w64-allegro4-static)
provides=(mingw-w64-allegro4-static)
...
package() {
  ...
  for _arch in ${_architectures}; do
    ...
    mv "$pkgdir/usr/"{bin,include,lib} "$pkgdir/usr/$_arch"
