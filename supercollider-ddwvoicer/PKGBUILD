...
pkgname=supercollider-ddwvoicer
pkgdesc="SuperCollider quark: A voice-stealing note player, with GUI and controls shared across nodes. Author: James Harkins."
_quark="ddwVoicer"
_path=dewdrop_lib/ddwVoicer
