...
pkgname=mozart2-git
pkgver=v2.0.0.alpha.0.4138.g3739933
pkgrel=1
...
source=( 
    ...
    'https://github.com/mozart/mozart2/pull/231.patch'
)
sha256sums=(
    'SKIP'
    'SKIP'
    '8cd7ad39305fcab148ad9b252598ea352157655ea4fc0ea3f9dffa35059a40a2'
)
...
_patch(){
    ...
    libs="LLVM-3.5 clang clangTooling clangFrontendTool clangFrontend \
