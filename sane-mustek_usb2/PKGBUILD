...
pkgname=sane-mustek_usb2
pkgver=1.0.21
pkgrel=1
pkgdesc="Scanner Access Now Easy (with mustek_usb2)"
...
source=(ftp://ftp.sane-project.org/pub/sane/sane-backends-$pkgver/sane-backends-$pkgver.tar.gz
        ftp://ftp.sane-project.org/pub/sane/sane-backends-$pkgver/sane-backends-1.0.21-i18n.patch
        sane.xinetd
...
build() {
  ...
  ./configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --with-docdir=/usr/share/doc/sane --enable-avahi --disable-latex --enable-pthread
  make
