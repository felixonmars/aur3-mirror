...
pkgname=kvantum-tools-qt4-svn
pkgver=r162
pkgrel=1
pkgdesc="Kvantum config tools build against Qt4"
arch=('i686' 'x86_64')
...
conflicts=('kdestyle-kvantum-kde4' 'kdestyle-kvantum-kde4-git' 'kvantum-tools-qt5-svn')
provides=("kvantum-tools-qt4=${pkgver}")
