...
# Contributor: Theo <theodoiq at yahoo.com.br>
_lang='pt-BR'
...
_install_prefix='opt'
_install_name='openoffice'
_install_path=${_install_prefix}/${_install_name}

pkgname=openoffice-base-bin_pt-br
pkgver=3.4.1
pkgrel=1
pkgdesc="OpenOffice - i18n ptBR Brazilian Portuguese"
arch=('i686' 'x86_64')
...
# AUR is tricky
source=( "http://sourceforge.net/projects/openofficeorg.mirror/files/localized/pt-BR/${pkgver}/" )
...
in i686 )
	...
	sha256sums[0]='909492fa45fc7611863629c6b716bc801e5ebd28e8e0383d05b4485844fd619d'
;; x86_64 )
	source[0]+="Apache_OpenOffice_incubating_${pkgver}_Linux_x86-64_install-rpm_${_lang}.tar.gz"
	sha256sums[0]='1e0cb9cf66023e66b9b355bd52e48d701108f6aa0943cbb5e3ade6bcabfcb12e'
esac
...
#		) usr/bin/${_install_name}
	...
	msg  "Empacotando o OpenOffice... tenha paciência, isso pode demorar um pouco... "
}
