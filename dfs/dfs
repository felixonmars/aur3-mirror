			 ...
			 BEGIN       {
				 ...
				 if (WEB_OUTPUT)
				 {
					 ...
					 printf ( \
							 ...
							 "<TD ALIGN=CENTER><STRONG>%% Used&nbsp;(<SPAN CLASS=\"titleblue\">*</SPAN>)" \
							 "&nbsp;-&nbsp;%% Free&nbsp;(<SPAN CLASS=\"titlegreen\">*</SPAN>)</STRONG></TD>\n" \
							 "<TD ALIGN=CENTER><STRONG>%% Used</STRONG></TD>\n" \
							 "<TD ALIGN=CENTER><STRONG>Free size</STRONG></TD>\n" \
							 "<TD ALIGN=CENTER><STRONG>Total size</STRONG></TD>\n" \
							 "</TR>\n" );
				 }
				 else
				 {
...
#           printf ("%-*s", LEFT_COLUMN + 2, "Mount point");
					 ...
					 print " Used (*)                                Free (-)  %Used  Free  Total";
					 if (! NARROW_MODE)
						 print "";
				 }
			 }
