...
pkgname=vacuum-kinotifications-hg
pkgver=3
pkgrel=1
pkgdesc="Kinetic notification plugin for Vacuum IM"
arch=('i686' 'x86_64')
url="http://code.google.com/p/vacuum-plugins/"
license=('GPL')
depends=(vacuum)
makedepends=('mercurial' 'git')
provides=(vacuum-kinotifications)

_hgroot="https://kinotifications.vacuum-plugins.googlecode.com/hg/"
_hgrepo="vacuum-plugins-kinotifications"
