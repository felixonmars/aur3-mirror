...
makedepends=(git gperf java-runtime)
optdepends=()
provides=('forked-daapd')
conflicts=('forked-daapd')
replaces=()
backup=(etc/forked-daapd.conf etc/avahi/services/forked-daapd.service)
options=()
install=forked-daapd.install
changelog=
source=('forked-daapd-git::git+https://github.com/ejurgensen/forked-daapd' forked-daapd.install forked-daapd.avahi forked-daapd.service http://www.antlr3.org/download/antlr-3.4-complete.jar)
noextract=()
md5sums=('SKIP'
