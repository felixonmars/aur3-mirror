...
depends=('qt4' 'zlib' 'freetype2' 'libsm' 'libxrender' 'libxext' 'bzip2' 'icu' 'rtmpdump' 'crypto++' 'nss' 'boost-libs' 'libqxt')

if [ "$CARCH" = "i686" ]; then
    source="http://archive.ubuntukylin.com:10006/ubuntukylin/pool/main/k/kuaipan4uk/kuaipan4uk_2.0.0.4_i386.deb"
    md5sums='720a58f62903f4b7cc768701a5dd7e26'
elif [ "$CARCH" = "x86_64" ]; then
    source="http://archive.ubuntukylin.com:10006/ubuntukylin/pool/main/k/kuaipan4uk/kuaipan4uk_2.0.0.4_amd64.deb"
    md5sums='4ea82224aadbf62aaae6bded2270019d'
fi
