...
pkgname=flightgear-aircrafts-b
pkgver=3.0
pkgrel=1
pkgdesc="Aircraft collection for Flightgear - Name beginning with letter B."
...
package() {
  ...
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/b*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/B*'	#get and unzip the aircrafts
