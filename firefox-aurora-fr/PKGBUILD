...
pkgver=32.0a2
pkgrel=1
pkgdesc="Firefox Aurora channel - Nightly build - French"
...
package() {
  ...
  install -Dm644 "firefox-aurora-fr.desktop" "${pkgdir}/usr/share/applications/firefox-aurora.desktop"
  install -Dm644 "firefox-aurora-fr-safe.desktop" "${pkgdir}/usr/share/applications/firefox-aurora-safe.desktop"
