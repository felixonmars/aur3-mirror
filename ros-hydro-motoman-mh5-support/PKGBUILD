...
pkgdesc="ROS -  ROS Industrial support for the Motoman mh5 (and variants)."
url='http://ros.org/wiki/motoman_mh5_support'

pkgname='ros-hydro-motoman-mh5-support'
pkgver='0.3.3'
_pkgver_patch=1
arch=('any')
pkgrel=2
...
_tag=release/hydro/motoman_mh5_support/${pkgver}-${_pkgver_patch}
_dir=motoman_mh5_support
