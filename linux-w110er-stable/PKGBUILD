...
# Based in linux package.
# Maintainer: Tobias Powalowski <tpowa@archlinux.org>
# Maintainer: Thomas Baechler <thomas@archlinux.org>

pkgbase=linux-w110er-stable       
_srcname=linux-3.12
_kernelpatch=312-gcc48-1
pkgver=3.12.20
pkgrel=1
arch=('x86_64')
...
source=("http://www.kernel.org/pub/linux/kernel/v3.x/${_srcname}.tar.xz"
        ...
        # the w110er kernel config files
        'config.w110er'
        # standard config files for mkinitcpio ramdisk
        'linux.preset'
        'change-default-console-loglevel.patch'
	#"https://raw.github.com/graysky2/kernel_gcc_patch/master/kernel-${_kernelpatch}.patch"
	https://raw.github.com/graysky2/kernel_gcc_patch/master/enable_additional_cpu_optimizations_for_gcc.patch
...
prepare() {
  ...
  # add gcc 4.8.1 support for Kconfig and menuconfig
  #patch -Np1 -i "${srcdir}/kernel-${_kernelpatch}.patch"
...
_package() {
  pkgdesc="Linux ${pkgver} kernel and modules optimized for my Mountain F11 Netbook (Clevo W110ER). Stable Version See PKGBUILD"
...
# AUR hack
pkgname="${pkgbase}"
pkgdesc="Linux ${pkgver} kernel and modules optimized for my Mountain F11 Netbook (Clevo W110ER). See PKGBUILD"
...
md5sums=('cc6ee608854e0da4b64f6c1ff8b6398c'
         '26a24b7274665e0ff2e7dd4e860eec91'
         '5e2b315718ca6c41c65cc8b05af06e72'
         '434092c585bb93bf2e68620e2be186ac'
         '05cf639f7e677d7aa739bbb583a71b7e'
         '6df39821af61ef134b4d8fc9406520a5'
         '5282429c68a927736a17243e27213bf8')
