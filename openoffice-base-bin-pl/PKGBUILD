...
# Contributor: Victor Pozdnyakov <vic dot pozd at gmail dot com>
...
pkgname=openoffice-base-bin-pl
pkgver=4.1.0
pkgrel=1
pkgdesc="OpenOffice - Polish version"
arch=('i686' 'x86_64')
...
# AUR is tricky
source=( "http://sourceforge.net/projects/openofficeorg.mirror/files/${pkgver}/binaries/${_lang}/" )
sha1sums=( '0000000000000000000000000000000000000000' )
case "$CARCH"
in i686 )
	source[0]+="Apache_OpenOffice_${pkgver}_Linux_x86_install-rpm_${_lang}.tar.gz/download"
	sha1sums[0]='8ce329bf8152a6c7c63fbfdb7d75c7815c98a4a0'
;; x86_64 )
	source[0]+="Apache_OpenOffice_${pkgver}_Linux_x86-64_install-rpm_${_lang}.tar.gz/download"
	sha1sums[0]='1e22ccb691db6b70f2b2b48fef17ccee7c9ec926'
esac
