...
pkgname=dropbox-faenza-light
pkgver=0.4
pkgrel=3
pkgdesc="Dropbox 0.8x icons for Faenza icon theme -- for light panels."
...
makedepends=()
provides=()
conflicts=('dropbox-faenza-dark' 'dropbox-humanity-dark-icons' 'dropbox-dark-panel-icons' 'dropbox-humanity-icons' 'dropbox-light-panel-icons' 'dropbox-ubuntu-mono-light' 'dropbox-ubuntu-mono-dark')
...
build() {
  ...
  cd ./ebethron-faenza-dropbox-icons-0.4/light-panel
