...
package() {
    ...
    install -m644 th_nn_NO_v2.dat th_nn_NO_v2.idx ${pkgdir}/usr/share/mythes

    install -dm755 ${pkgdir}/usr/share/myspell/dicts
    ln -s /usr/share/mythes/th_nn_NO_v2.dat ${pkgdir}/usr/share/myspell/dicts/th_nn_NO_v2.dat
    ln -s /usr/share/mythes/th_nn_NO_v2.idx ${pkgdir}/usr/share/myspell/dicts/th_nn_NO_v2.idx
