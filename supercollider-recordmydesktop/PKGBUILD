...
pkgname=supercollider-recordmydesktop
pkgdesc="SuperCollider quark: A class to create a screencast with recordmydesktop. Author: Marije Baalman."
_quark="RecordMyDesktop"
_path=LinuxExternal/RecordMyDesktop
