...
pkgbase="kernel26-pnfs"
pkgname=kernel26-pnfs       # Build kernel with a different name
...
md5sums=('1aab7a741abe08d42e8eccf20de61e05'
         ...
         'bd6ad36168d8c74e95635bb7e1adbfc2'
         'b139b82fe57dd77aae9039ef6c2135c9'
...
package() {
  pkgdesc="The Linux Kernel and modules with NFS v4.1 and pNFS enabled"
  groups=('base')
