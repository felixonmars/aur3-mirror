...
_ruby="/usr/bin/ruby"
_gem="/usr/bin/gem"
pkgname="ruby-fuzzy-match"
pkgver="2.0.1"
pkgrel=1
pkgdesc="Find a needle in a haystack using string similarity and (optionally) regexp rules. Replaces loose_tight_dictionary."
arch=("any")
url="https://github.com/seamusabshere/fuzzy_match"
license=("custom:ruby-fuzzy-match")
...
depends=("ruby")
conflicts=()
optdepends=("ruby-active-record-inline-schema: Define table structure (columns and indexes) inside your ActiveRecord models lik..."
            "ruby-pry: An IRB alternative and runtime developer console"
            "ruby-rspec-core: rspec-core-2.13.1"
            "ruby-rspec-expectations: rspec-expectations-2.13.0"
            "ruby-rspec-mocks: rspec-mocks-2.13.1"
            "ruby-activerecord: Object-relational mapper framework (part of Rails)."
            "ruby-mysql2: A simple, fast Mysql library for Ruby, binding to libmysql"
            "ruby-cohort-analysis: Lets you do cohort analysis based on two strategies: \"big\", which discards chara..."
            "ruby-weighted-average: Perform weighted averages. Rails 3 only."
            "ruby-yard: Documentation tool for consistent and usable documentation in Ruby."
            "ruby-amatch: Approximate String Matching library")
source=("https://rubygems.org/gems/$_gemname-$pkgver.gem")
sha256sums=("073beaff01b90a537909732fd35dbf357ea47a3fa9af747f648e334eeaccf90c")
