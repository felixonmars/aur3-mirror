...
license=('custom')
depends=('pcsclite')
source=('http://hg.honeyplanet.jp/pt1/archive/c44e16dbb0e2.tar.bz2' 'Makefile.patch' 'libb25.install')
md5sums=('805e4c7778e88521847b105eaf0b3e56' '9f6555c6c7956b03e1c42a5c0e3dde1f' 'c3676748519977c008b119d75f98aeda')
install='libb25.install'
build() {
