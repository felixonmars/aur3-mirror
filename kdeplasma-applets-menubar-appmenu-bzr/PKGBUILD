...
pkgname=kdeplasma-applets-menubar-appmenu-bzr
pkgver=103
pkgrel=3
...
license=('GPL')
depends=('kded-appmenu' 'libkappmenu-git' 'qjson' 'libdbusmenu-qt' 'appmenu-qt')
...
provides=('plasma-widget-menubar=0.1.16' 'kdeplasma-applets-menubar-appmenu=103')
conflicts=('plasma-widget-menubar''plasma-widget-menubar-appmenu-bzr')
replaces=('plasma-widget-menubar' 'plasma-widget-menubar-appmenu-bzr')
