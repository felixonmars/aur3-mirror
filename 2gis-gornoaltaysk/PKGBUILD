...
pkgver=38
pkgrel=1
pkgdesc="Map of Gorny Altai for 2GIS, June 2013"
arch=('i686' 'x86_64')
url="http://altai.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.5.1')
source=("http://download.2gis.ru/arhives/2GISData_Gornoaltaysk-38.orig.zip")
md5sums=('8b70438360966a103f14d0bc381f166d')
