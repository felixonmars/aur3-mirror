...
pkgver=6246
pkgrel=1
pkgdesc="Collection of user space tools for general SMBus access and hardware monitoring. SVN Trunk"
arch=('i686' 'x86_64')
...
makedepends=('rrdtool' 'subversion')
optdepends=('rrdtool: for logging with sensord')
backup=('etc/sensors3.conf' 'etc/healthd.conf' 'etc/conf.d/sensord')
source=("svn+http://lm-sensors.org/svn/lm-sensors/trunk"
