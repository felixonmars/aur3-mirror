...
pkgver=29
pkgrel=1
pkgdesc="Map of Ivanovo for 2GIS, September 2014"
arch=('i686' 'x86_64')
url="http://info.2gis.ru/ivanovo/products/download#linux"
license=('custom')
depends=('2gis>=3.14.7.0')
source=("http://download.2gis.com/arhives/2GISData_Ivanovo-29.orig.zip")
md5sums=('50e8926f08433377c832d321acf52cf2')
