...
# Uncomment the line below if you want wine installed to /opt/wine-csmt instead of replacing wine
#customprefix=1
...
if [[ $customprefix != 1 ]]; then
  ...
  # change _prefix if you don't want to use the default custom prefix of /opt/wine-csmt
  _prefix="opt/$pkgname"
