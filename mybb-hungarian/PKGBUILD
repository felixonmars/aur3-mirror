...
pkgname=mybb-hungarian
pkgver=1.4.00
pkgrel=1
pkgdesc='Hungarian language to the MyBB. It includes the translation as well as translated images.'
arch=('i686' 'x86_64')
url=('http://mybb.com/downloads/translations')
license=('GPL')
depends=('mybb')
makedepends=('unzip')
source=("lang_hungarian_1400.zip::http://mybb.com/download/75/zip")
...
md5sums=('4df460576533883cce600e6a273a8b61')
