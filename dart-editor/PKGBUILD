...
if [[ ${CARCH} = x86_64 ]]; then
	source=("https://storage.googleapis.com/dart-archive/channels/stable/release/45396/editor/darteditor-linux-x64.zip")
	md5sums=('4cc2d35dbb05e65e0df4566eb05d202b')
else
	source=("https://storage.googleapis.com/dart-archive/channels/stable/release/45396/editor/darteditor-linux-ia32.zip")
	md5sums=('e2d8c189c2aeeb28fed518f5c8a96f5d')
fi
