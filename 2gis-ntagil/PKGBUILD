...
pkgver=18
pkgrel=1
pkgdesc="Map of Nizhny Tagil for 2GIS, December 2012"
arch=('i686' 'x86_64')
url="http://ntagil.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.12.0.2')
source=("http://download.2gis.ru/arhives/2GISData_Ntagil-18.orig.zip")
md5sums=('93592b869152db4b3121c4686da13447')
