# Maintainer: Iván De Gyves (FoxBuru) <fox@foxburu.mx>

pkgbase=linux-vserver
pkgname=linux-vserver
true && pkgname=('linux-vserver' 'linux-vserver-headers' 'linux-vserver-docs')
...
options=('!strip')
optdepends=('util-vserver: General utilities for vserver kernel.')
source=("http://www.kernel.org/pub/linux/kernel/v3.x/linux-${_basekernel}.tar.xz"
        # "http://ftp.ntu.edu.tw/ftp/pub2/linux/kernel/v3.0/patch-${pkgver}.xz"
        ...
        'vserv-ext4-opts.patch'
        "http://vserver.13thfloor.at/Experimental/patch-${pkgver}-vs${_vserver}.diff")
md5sums=('7133f5a2086a7d7ef97abac610c094f5'
         '4c414154fa6b3c14a1cbfc434dc07153'
         'ce884210080d396371c21831e78cb371'
         '6fbcc5826014c06677c8434763b3cc6f'
         '9a18a61917a474d4ab1bbea81c151c24'
         '3cb9e819538197398aad5db5529b22d6'
         '9d3c56a4b999c8bfbd4018089a62f662'
         '342071f852564e1ad03b79271a90b1a5'
         'e787ef4bc66e2d9a7883eaece7a915b9'
         'd5eb5ac9774cac700d6368e9c0f2fca3'
         '1c69af3edad838cff093078043949129')

build() {
  # Apply first patch ext4 to patch vserver
  cd "${srcdir}"
  patch -N -i "${srcdir}/vserv-ext4-opts.patch"

  # Flow our normal building
  ...
  # Lastly, but not less important, the VServer Patch :3
...
package_linux-vserver() {
  pkgdesc="The Linux Kernel and modules. With vServer patch."
  groups=('base')
  ...
  ln -s "../extramodules-${_basekernel}${_kernelname:--vs2.3.3.1}" "${pkgdir}/lib/modules/${_kernver}/extramodules"
  # add real version for building modules and running depmod from post_install/upgrade
  mkdir -p "${pkgdir}/lib/modules/extramodules-${_basekernel}${_kernelname:--vs2.3.3.1}"
  echo "${_kernver}" > "${pkgdir}/lib/modules/extramodules-${_basekernel}${_kernelname:--vs2.3.3.1}/version"
}

package_linux-vserver-headers() {
  pkgdesc="Header files and scripts for building modules for linux kernel"
  provides=('kernel26-headers' 'linux-headers')
...
package_linux-vserver-docs() {
  pkgdesc="Kernel hackers manual - HTML documentation that comes with the Linux kernel."
  provides=('kernel26-docs' 'linux-docs')
