...
md5sums=("f9c782399f1609c67bb78405a8d6e021"
         "22021a769836216cddf0ab4852cc513f"
         "8890df835bcc8a6d50eaa200d23f8117"
         "852f796987de7f3f35b2c61e2acba90e"
         ...
         "708b3dcf0b09e4180b2b10ae446547e5"
         "59e3700626fe06e1bed7fb691ef9080a"
         "9e6f95591b67f00eafa4a56c3c2bbf83")
sha1sums=("c107f2776d05f3124597c855222b3412a3bede76"
          "2abcdda589682f3c6c028778cca46eeb4eea7221"
          "ffae9aacd6ba7767d8037fcab331936f8b73d92e"
          "e96b4829f5b536bbc2263c311935a61f7cdc1f8e"
          ...
          "095229a4719d86a96ab9f3b02263b2ce66fc4ab7"
          "7279e7acef9ef5f65556999e275237b723bd22e4"
...
build() {
  ...
  # We need gcc below version 5 to build this kernel, sorry
  if [ $(which gcc-4.9) ]; then
    echo "use gcc 4.9 for compiling"
    patch -uNp1 -i "${srcdir}/gcc49.patch"
  elif [ $(which gcc-4.8) ]; then
    echo "use gcc 4.8 for compiling"
    patch -uNp1 -i "${srcdir}/gcc48.patch"
  elif [ $(which gcc-4.7) ]; then
    ...
    echo "please install gcc 4.9, 4.8, 4.7, 4.6 or 4.4 from AUR to compile ${pkgname}"
    exit 1
  fi
