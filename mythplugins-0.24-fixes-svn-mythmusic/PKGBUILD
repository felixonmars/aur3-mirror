...
pkgname=mythplugins-0.24-fixes-svn-mythmusic
pkgver=27371
pkgrel=2
arch=('i686' 'x86_64')
...
package_mythplugins-0.24-fixes-svn-mythmusic() {
  pkgdesc="Music playing plugin for MythTV"
  depends=("mythtv-0.24-fixes-svn" 'cdparanoia' 'flac' 'libcdaudio' 'libvisual'
           'libvorbis' 'sdl' 'taglib')
  conflicts=('mythplugins-mythmusic')
  provides=('mythplugins-mythmusic')
