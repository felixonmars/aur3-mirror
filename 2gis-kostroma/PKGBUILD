...
pkgver=46
pkgrel=1
pkgdesc="Map of Kostroma for 2GIS, August 2014"
arch=('i686' 'x86_64')
url="http://info.2gis.ru/kostroma/products/download#linux"
license=('custom')
depends=('2gis>=3.14.7.0')
source=("http://download.2gis.com/arhives/2GISData_Kostroma-46.orig.zip")
md5sums=('e484f15da96694fc634a7969ec5f0ff8')
