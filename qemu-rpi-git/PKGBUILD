...
_gitname=qemu
pkgver=1.7.r28335.gc84dccd
pkgrel=2
pkgdesc="A generic and open source processor emulator which achieves a good emulation speed by using dynamic translation. Git version with Raspberry Pi emulation."
arch=('i686' 'x86_64')
license=('GPL2' 'LGPL2')
...
source=("git+https://github.com/Torlus/qemu.git#branch=rpi"
        '65-kvm.rules'
        'qemu.install')
sha256sums=('SKIP'
