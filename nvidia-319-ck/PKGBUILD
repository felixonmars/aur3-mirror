...
depends=('linux-ck>=3.12' 'linux-ck<3.13' "nvidia-319-libgl" "nvidia-319-utils=${pkgver}")
...
options=(!strip)
source=('.AURINFO' 'nvidia-linux-3.10.patch' 'nvidia-linux-3.12.patch')
md5sums=('fb50c1b0926f3bddf32029c7c72dccb7' '547b74f49f81b22f214e2770e31d62b6' '60e7c3b1241400092f8e507ae59686ea')
