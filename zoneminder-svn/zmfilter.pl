...
# ==========================================================================
#
# ZoneMinder Event Filter Script, $Date: 2010-02-28 14:03:27 -0800 (Sun, 28 Feb 2010) $, $Revision: 3041 $
...
use lib '/usr/share/perl5/site_perl/5.10.1'; # Include custom perl install path
use ZoneMinder;
use DBI;
use POSIX;
