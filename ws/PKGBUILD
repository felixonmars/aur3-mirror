# Maintainer: Manuel Carreira <arch@carreira.com.pt>
pkgname=ws
pkgver=0.6.3
_pkgver=0.6-3
pkgrel=2
...
build() {
  ...
  install -o 0 -g 0 -d -m 0755 $pkgdir/usr/sbin
  ...
  install -m 750 ws-auto $pkgdir/usr/sbin/ws-auto
  install -m 755 ws $pkgdir/usr/bin/ws
  install -m 750 ws-confsudo $pkgdir/usr/sbin/ws-confsudo
