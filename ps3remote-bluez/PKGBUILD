...
pkgver=4.101
pkgrel=6
pkgdesc="Deprecated daemon and tools for the Bluetooth protocol stack with kitlaan's ps3remote patch applied."
url="http://www.bluez.org/"
arch=('i686' 'x86_64')
license=('GPL2')
depends=('dbus' 'bluez-utils')
conflicts=('bluez4' 'bluez' 'bluez-cups')
...
optdepends=("gstreamer0.10-base: bluetooth GStreamer support"
            ...
            "cups: CUPS backend")
provides=('bluez4=${pkgver}')
replaces=('bluez4' "bluez<=$pkgver")
