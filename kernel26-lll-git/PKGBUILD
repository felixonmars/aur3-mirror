...
# Package inspired by: https://aur.archlinux.org/packages.php?ID=25304
# also check: https://github.com/lll-project/kernel/wiki/kernel_build_instructions
...
pkgdesc="The Linux Kernel and modules, patched to be compiled by LLVM/Clang"
depends=('coreutils' 'linux-firmware-git' 'module-init-tools' 'mkinitcpio' 'lll-git')
...
_gitroot="git://github.com/lll-project/kernel.git"
...
build() {
	...
	export HOSTCC=$CC
	export CXX=clang++
	export CFLAGS="-Os -march=native -mtune=native"
