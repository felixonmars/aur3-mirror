...
# Contributor: Jonathan Wiersma <archaur at jonw dot org> (x86_64)
...
conflicts=('picasa')
provides=('picasa')
depends=('freetype2' 'libgphoto2' 'hal' 'wine')
[ "$CARCH" = "x86_64" ] && depends=('freetype2' 'libgphoto2' 'hal' 'bin32-wine' 'lib32-nss' 'lib32-openssl')
makedepends=('rpmextract')
install=picasa.install
source=(http://dl.google.com/linux/rpm/testing/i386/picasa-3.0-current.i386.rpm
        picasa.desktop
        picasa.patch
        LICENSE
        uninstall.html)
