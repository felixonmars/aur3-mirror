...
pkgname=google-chrome-mini
pkgver=next   # update  Check for new Linux releases in: http://googlechromereleases.blogspot.com/search/label/Dev%20updates
pkgrel=1
...
package() {
    ...
    wget -O cr.rpm "http://dl.google.com/dl/linux/direct/google-chrome-unstable_current_${_arch}.rpm"
    bsdtar xvf cr.rpm
