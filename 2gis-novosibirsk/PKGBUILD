...
pkgver=176
pkgrel=2
pkgdesc="Map of Novosibirsk for 2GIS, May 2013"
arch=('i686' 'x86_64')
url="http://nsk.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.5.1')
source=("http://download.2gis.ru/arhives/2GISData_Novosibirsk-176.orig.zip")
md5sums=('fe79d357709db2f4594d0f5e0f5532a8')
