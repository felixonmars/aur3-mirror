...
pkgname=haskell-xmonad-gnome3
pkgver=20141022
pkgrel=2
pkgdesc="Minimal XMonad/GNOME3 hybrid desktop configuration. Pulls xmonad and xmonad-contrib from ArchHaskell"
arch=('i686' 'x86_64')
url="https://github.com/tonyskn/arch-aur-packages/tree/master/xmonad-gnome3"
license=('MIT')

conflicts=('xmonad-gnome3')
