...
pkgname=mintdm-themes
_pkgbase=mdm-themes
_pkgname=('mdm-themes' 'mdm-themes-extra')
pkgver=0.1.5
pkgrel=1
...
license=('GPL' 'BSD')
depends=('mdm')
source=("$_pkgname-$pkgver.tar.gz::http://git.manjaro.org/artwork/mdm-themes/repository/archive.tar.gz?ref=$pkgver"
...
sha256sums=(eba6833597cc5d5abb88fcfe1d1f29f1fcc15e45212cd7e39bd15b23687c338e
