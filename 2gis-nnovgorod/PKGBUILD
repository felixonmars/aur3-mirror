...
pkgver=71
pkgrel=1
pkgdesc="Map of Nizhny Novgorod for 2GIS, August 2014"
arch=('i686' 'x86_64')
url="http://info.2gis.ru/nizhniy-novgorod/products/download#linux"
license=('custom')
depends=('2gis>=3.14.7.0')
source=("http://download.2gis.com/arhives/2GISData_N_Novgorod-71.orig.zip")
md5sums=('8556bb9f8e76014d045070dd60f55b23')
