...
pkgver=27
pkgrel=1
pkgdesc="Map of Sterlitamak for 2GIS, February 2014"
arch=('i686' 'x86_64')
url="http://sterlitamak.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.11.0')
source=("http://download.2gis.ru/arhives/2GISData_Sterlitamak-27.orig.zip")
md5sums=('13cca04b1d176f593b1ada27902718fe')
