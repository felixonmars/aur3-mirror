...
pkgdesc="ROS - This package provides generic capability for industrial controllers."
url='http://www.ros.org/'

pkgname='ros-hydro-open-controllers-interface'
pkgver='0.1.4'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
_tag=release/hydro/open_controllers_interface/${pkgver}-${_pkgver_patch}
_dir=open_controllers_interface
