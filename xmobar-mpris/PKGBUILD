...
makedepends=('ghc=7.4.2-1' 'haskell-x11=1.6.0' 'haskell-x11-xft=0.3.1' 'haskell-utf8-string'
	     'haskell-stm>=2.3' 'haskell-parsec>=3.1' 'haskell-mtl>=2' 'haskell-dbus-core')
conflicts=('xmobar')
options=('strip')
...
build() {
    ...
    runhaskell Setup configure --disable-optimization --prefix=/usr --flags="with_utf8 with_xft with_iwlib with_mpris"
...
md5sums=('0658679b39168f49d32fe178029ff9f1'
         'c0e0f5f6ebee5eacd6ccbe681fa8f76f')
