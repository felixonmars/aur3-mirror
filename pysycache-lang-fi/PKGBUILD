...
pkgname=pysycache-lang-fi
pkgver=3.1b
pkgrel=1
pkgdesc="Finnish language pack for PySyCache"
arch=('any')
url="http://www.pysycache.org/"
license=("GPL")
depends=('pysycache')
source=(http://download.tuxfamily.org/py4childs/themes/themes-move/pack-lang-gpl-fi-${pkgver}.zip)
md5sums=('0288ed7409ac816f75175d008bc3acae')
