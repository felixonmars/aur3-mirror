...
pkgname=tortoisehg-stable-hg
pkgver=3161
pkgrel=1
pkgdesc="GUI frontend for mercurial including hgtk and nautilus plugin - TortoiseHG Stable Repository"
arch=(i686 x86_64)
url="http://bitbucket.org/tortoisehg/"
license=('GPL2')
makedepends=('mercurial')
depends=('python-nautilus>=0.5.0-2' 'mercurial' 'python-iniparse' 'pyqt')
