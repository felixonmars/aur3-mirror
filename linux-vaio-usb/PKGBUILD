...
pkgbase=linux-vaio-usb       # Build kernel with a different name
_srcname=linux-3.14
pkgver=3.14.4
pkgrel=3
arch=('i686' 'x86_64')
...
sha256sums=('SKIP'
            ...
            '01e5cee98140909766bb20b0a9cec20e35633e58ded7cad8a583f3b21dbc4ec5')
...
prepare() {
  ...
  # sony fix for usb
  # patch at: https://bugs.launchpad.net/ubuntu/+source/linux/+bug/1210858/comments/32
  # bug thread: https://bugs.launchpad.net/ubuntu/+source/linux/+bug/1210858
  patch -Np1 -i "${srcdir}/0016-fix-sony-usb.patch"
