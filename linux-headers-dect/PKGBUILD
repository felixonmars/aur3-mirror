...
pkgbase=linux-headers-dect
#pkgname=('linux' 'linux-headers' 'linux-docs') # Build stock -ARCH kernel
pkgname=('linux-headers-dect')       # Build kernel with a different name
...
package() {
  pkgdesc="Header files and scripts for building modules for linux kernel (with dect support)"
  #provides=('kernel26-headers')
  #conflicts=('kernel26-headers')
  #replaces=('kernel26-headers')
  backup=("usr/include/linux/socket.h", "usr/include/linux/netlink.h")
