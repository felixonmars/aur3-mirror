# $Id: PKGBUILD 58211 2009-11-05 23:54:13Z thomas $
...
source=(http://www.kernel.org/pub/linux/utils/kernel/hotplug/$pkgname-$pkgver.tar.bz2
        ...
        arch-udev-rules.patch ignore-remove.sh cups-hplip-fix.patch udev-acl.patch)
