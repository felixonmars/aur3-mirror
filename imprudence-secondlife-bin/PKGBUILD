...
pkgname=imprudence-secondlife-bin
pkgver=1.3.2
pkgrel=1
_arch=x86
pkgdesc="Second Life is a 3-D virtual world entirely built and owned by its residents. Imprudence is alternative viewer(native 32bit)"
...
[ "$CARCH" = "x86_64" ] && depends=('lib32-freealut' 'lib32-gtk2' 'lib32-libgl' 'lib32-libidn' 'lib32-libjpeg6' 'lib32-libpng12' 'lib32-libxdamage' 'lib32-mesa' 'lib32-nss')
[ "$CARCH" = "x86_64" ] && optdepends=('lib32-nvidia-utils: GL support for NVIDIA drivers')
arch=('i686' 'x86_64')
conflicts=('imprudence-secondlife-bin-x86_64')
...
md5sums=('ac7422e51eefdeb2f11910e36ad0d2d2'
         ...
         '4d2708955ab5f80fa34aea12d5ad8662')
