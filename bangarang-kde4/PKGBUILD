...
# Maintainer: Guido Iodice <guido dot iodice ar gmail dot com>

pkgname=bangarang-kde4
pkgver=20141231
pkgrel=1
...
license=('LGPL')
depends=('kdebase-runtime' 'taglib' 'gstreamer0.10-good-plugins')
makedepends=('git' 'cmake' 'automoc4')
provides=('bangarang')
conflicts=('bangarang' 'bangarang-git')
...
build() {
  ...
  cp -r "$srcdir/$_gitname/legacy" "$srcdir/$_gitname-build"
