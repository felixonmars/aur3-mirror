...
pkgname='ros-hydro-controller-manager-tests'
pkgver='0.7.2'
_pkgver_patch=1
arch=('any')
pkgrel=1
...
ros_makedepends=(ros-hydro-controller-manager
...
ros_depends=(ros-hydro-controller-manager
  ros-hydro-control-toolbox
  ros-hydro-controller-interface
  ros-hydro-rostest)
depends=(${ros_depends[@]})

_tag=release/hydro/controller_manager_tests/${pkgver}-${_pkgver_patch}
