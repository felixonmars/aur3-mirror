...
license=('WTFPL')
source=(${pkgname%-git}::git+https://github.com/whatyouhide/vim-lengthmatters)
sha256sums=('SKIP')
provides=('vim-lengthmatters')
conflicts=('vim-lengthmatters')
