# $Id: PKGBUILD 214051 2014-06-03 08:02:21Z tpowa $
# Maintainer: Tobias Powalowski <tpowa@archlinux.org>
# Maintainer: Thomas Baechler <thomas@archlinux.org>

#pkgbase=linux               # Build stock -ARCH kernel
pkgbase=linux-samsung-netbook       # Build kernel with a different name
_srcname=linux-3.14
pkgver=3.14.5
pkgrel=1
arch=('i686' 'x86_64')
...
source=("https://www.kernel.org/pub/linux/kernel/v3.x/${_srcname}.tar.xz"
        ...
        '0001-ACPI-EC-Process-rather-than-discard-events-in-acpi_e.patch'
        )
sha256sums=('61558aa490855f42b6340d1a1596be47454909629327c49a5e4e10268065dffa'
            ...
            'd19b3dd1ac0eac03e6e325c68e2fe7d5cdb93fd6d44ca0b3b9c58a8249dc7ad0')
...
prepare() {
  ...
  # fix lid switch not detected after resume on samsung netbook
  # https://bugzilla.kernel.org/show_bug.cgi?id=44161#c173
  # https://lkml.kernel.org/r/532FE3B2.9060808@biereigel-wb.de
  patch -Np1 -i "${srcdir}/ec_process.patch"
...
pkgname=linux-samsung-netbook
pkgdesc="The Linux kernel with a fix for samsung netbook to detect lid open"
