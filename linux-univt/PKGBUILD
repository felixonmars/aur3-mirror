# Maintainer: neil <neil.sun@live.com>
# Contributor: youbest <youbest@sina.com>

#pkgbase=linux            # Build stock -ARCH kernel
pkgbase=linux-univt       # Build kernel with a different name
_srcname=linux-3.12
pkgver=3.12.2
pkgrel=1
arch=('i686' 'x86_64')
...
source=("http://www.kernel.org/pub/linux/kernel/v3.x/${_srcname}.tar.xz"
        ...
        'linux.preset'
        # add unicode virtual terminal
        "https://dl.dropboxusercontent.com/u/20073199/linux/utf8-kernel-3.0.82-core-1.patch"
        "https://dl.dropboxusercontent.com/u/20073199/linux/utf8-kernel-2.6-fonts-3.patch.tar.xz"
...
md5sums=('cc6ee608854e0da4b64f6c1ff8b6398c'
         ...
         # add unicode virtual terminal
         '8f2b467f225deb7ce665fc43df077810'
         '3d2e79a66aea2ffd0ad91690decbc6ef'
...
prepare() {
  ...
  # add unicode virtual terminal support
  # http://blog.chinaunix.net/uid-436750-id-2123586.html
  patch -Np1 -i "${srcdir}/utf8-kernel-3.0.82-core-1.patch"
  patch -Np1 -i "${srcdir}/utf8-kernel-2.6-fonts-3.patch"
...
pkgname=("${pkgbase}")
pkgdesc="The ${pkgbase} kernel, displays Unicode in console"
