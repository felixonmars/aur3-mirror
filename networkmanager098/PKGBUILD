...
pkgbase=networkmanager098
pkgname=(networkmanager098 libnm098-glib)
pkgver=0.9.8.10
pkgrel=1
pkgdesc="Network Management daemon (0.9.8.x series)"
arch=(i686 x86_64)
...
package_networkmanager098() {
  depends=(libnm098-glib iproute2 libnl polkit wpa_supplicant dhcp-client libsoup libmm-glib)
  optdepends=('dhclient: DHCPv6 support'
              'dnsmasq: Connection sharing'
              'bluez: Bluetooth support'
              'openresolv: resolvconf support'
              'ppp: Dialup connection support')
  provides=("${pkgname/098/}=${pkgver}")
  conflicts=("${pkgname/098/}")
...
package_libnm098-glib() {
  pkgdesc="NetworkManager library (0.9.8.x series)"
