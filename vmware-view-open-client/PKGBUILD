...
pkgname=vmware-view-open-client
_realname=VMware-view-open-client
pkgver=4.5.0
_realver=4.5.0-297975
pkgrel=7
pkgdesc="VMware View Open Client connects to virtual machines managed by VMware View"
conflicts=('vmware-view-client' 'vmware-view-open-client-beta')
provides='vmware-view-open-client-beta'
arch=('i686' 'x86_64')
