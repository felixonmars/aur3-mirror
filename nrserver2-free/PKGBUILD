...
source=('http://download.neorouter.com/Downloads/NRFree/Update_2.1.2.4326/Linux/CentOS/nrserver-2.1.2.4326-free-centos-i386.rpm' 'nrserver.service')
md5sums=('82638efadba7bbb35eaa65e36f19f92c'
'd36bf55b94871288697eead0f878614c')
if test "$CARCH" == x86_64; then
source=('http://download.neorouter.com/Downloads/NRFree/Update_2.1.2.4326/Linux/CentOS/nrserver-2.1.2.4326-free-centos-x86_64.rpm' 'nrserver.service')
...
i686)
cd $srcdir/
rpmextract.sh $startdir/src/nrserver-2.1.2.4326-free-centos-i386.rpm
rm $startdir/src/nrserver-2.1.2.4326-free-centos-i386.rpm
;;
x86_64)
cd $srcdir/
rpmextract.sh $startdir/src/nrserver-2.1.2.4326-free-centos-x86_64.rpm
rm $startdir/src/nrserver-2.1.2.4326-free-centos-x86_64.rpm
;;
esac
}
