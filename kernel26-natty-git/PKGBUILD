...
pkgdesc="The Ubuntu Kernel and modules including Ubuntu Supplied Third-Party Device Drivers (NDISWRAPPER, RTL8192SE, ureadahead & more)"

pkgver=20110512
pkgrel=3
url="http://kernel.ubuntu.com/git-repos/ubuntu/ubuntu-natty.git/"
arch=(i686 x86_64)
license=('GPL2')
...
md5sums=('9dcccee11358143b86b22036b2da73fc'
         '2f188477857d3f88bb8d48f2e1b62085')
sha256sums=('c0fa684833ee64e021b01ce1322b3c9f31d299faa0e9b282da52aa64fab1b9f5'
            '1f5a6eff737dfc24366884e36827f3a7957bf65ebe8273b33395d66425e0c654')
_gitroot="git://kernel.ubuntu.com/ubuntu/ubuntu-natty.git"
_gitname="ubuntu-natty"
...
_generic_package_kernel() {
	pkgdesc="The Ubuntu Kernel and modules from natty git tree"
	depends=('coreutils' 'linux-firmware-git' 'module-init-tools>=3.12-2' 'mkinitcpio>=0.6.8-2')
	backup=(etc/mkinitcpio.d/$pkgname.preset)
	install=$pkgname.install
	changelog=$pkgname.changelog
