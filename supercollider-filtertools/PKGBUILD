...
pkgname=supercollider-filtertools
pkgdesc="SuperCollider quark: A set of classes for designing filters according to a pole/zero diagram Author: Michael Dzjaparidze."
_quark="FilterTools"
_path=FilterTools
