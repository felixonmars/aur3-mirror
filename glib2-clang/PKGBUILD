# Contributor: ogaby < ogaby @ web dot de  >
pkgname=glib2-clang
pkgver=2.24.0
pkgrel=1
pkgdesc="Common C routines used by GTK+ and QT compiled with clang"
url="http://www.gtk.org/"
arch=(i686 x86_64)
license=('custom')
depends=('pcre>=8.02' 'clang>2.6')
...
build() {
  ...
  ./configure CC=clang --prefix=/usr --enable-static --enable-shared \
