...
pkgname=kdebase-workspace-middleclickclose
_origpkgname=kdebase-workspace
_pkgname=kde-workspace
pkgver=4.11.12
_pkgver=4.14.1
pkgrel=1
pkgdesc="Adds a patch to allow the use of middle click to close windows in the Present Windows kwin effect."
arch=('i686' 'x86_64')
...
sha1sums=('64765044c0b0c487420594280eda379e7216eb8d'
          ...
          '851bdc78b2ed0ba4b63896e35e76c6c47e9f9e8f')
...
prepare() {
        ...
        # KDEBUG#321190
        patch -p1 -i "${srcdir}"/kwin-middleclickclose.patch
}
