...
'libxcomposite' 'alsa-lib' 'libxdamage' 'libxfixes' 'libcups' 'libgcrypt' 'expat' 'gcc-libs' 'pcre' 'libffi' 'libxinerama' 'libxi' 'libxcursor' 'harfbuzz' 'libpng' 'pixman' 'zlib' 'bzip2' 'dbus-glib' 'krb5' 'e2fsprogs' 'gnutls' 'avahi' 'libgpg-error' 'libxau' 'libxdmcp' 'graphite' 'libx11' 'wayland' 'mesa' 'systemd' 'libdrm' 'libxcb' 'libxxf86vm' 'keyutils' 'p11-kit' 'libtasn1' 'nettle' 'gmp')
optdepends=('ttf-tahoma: default Maxthon font')
