...
pkgname=legasynth-jack
pkgver=0.4.1
pkgrel=2
pkgdesc="Legacy synthesizer (e.g. MOS SID) emulator (with JACK support)"
url="http://sourceforge.net/projects/cheesetronic/"
license="GPL"
arch=('i686')
depends=(gtkmm1 alsa-lib jack-audio-connection-kit)
source=(http://dl.sourceforge.net/sourceforge/cheesetronic/legasynth-$pkgver.tar.gz \
    gcc4.patch)
