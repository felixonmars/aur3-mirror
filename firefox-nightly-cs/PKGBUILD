# Maintainer: Kubino <111999555 @t email.cz>
# Contributor: Kubino <111999555 @t email.cz>

pkgname=firefox-nightly-cs
pkgdesc='Standalone web browser from mozilla.org, nightly build, czech'
...
package() {
  FX_SRC="firefox-${pkgver}.cs.linux-${CARCH}.tar.bz2"
