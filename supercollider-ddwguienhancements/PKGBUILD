...
pkgname=supercollider-ddwguienhancements
pkgdesc="SuperCollider quark: Some new GUI features used by other parts of the library. Author: James Harkins."
_quark="ddwGUIEnhancements"
_path=dewdrop_lib/ddwGUIEnhancements
