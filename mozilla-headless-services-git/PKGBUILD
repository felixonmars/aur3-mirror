...
pkgname=mozilla-headless-services-git
_pkgname=mozilla-headless-services
pkgver=20090706
pkgrel=1
pkgdesc="Gecko for embedding, such as into clutter"
arch=('i686' 'x86_64')
url="http://www.moblin.org"
license=('GPL')
depends=(xulrunner-headless-hg)
makedepends=('git')
provides=($_pkgname)
conflicts=($_pkgname)
