...
pkgname=broadcom-wl-bfs
pkgver=6.30.223.248
pkgrel=9
_pkgdesc='Broadcom 802.11abgn hybrid Linux networking device driver for linux-bfs.'
...
install=broadcom-wl-bfs.install
...
package() {
	...
	install -Dm644 modprobe.d "${pkgdir}/usr/lib/modprobe.d/broadcom-wl_bfs.conf"
}
