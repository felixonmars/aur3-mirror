...
pkgname=linux-toshiba       # Build kernel with a different name
...
md5sums=('967f72983655e2479f951195953e8480'
         ...
         '575dd74cc329752b743cb86cd0bebd79'
         '38c1fd4a1f303f1f6c38e7f082727e2f'
         '9d3c56a4b999c8bfbd4018089a62f662'
         '263725f20c0b9eb9c353040792d644e5'
         '905d12d89cf01b43cb94f11e8a281a79')
...
build() {
  ...
  if [ "${CARCH}" = "x86_64" ]; then
	...
	# add configuration options for the custom DSDT file
	echo "CONFIG_STANDALONE=n" >> ./.config
	echo "CONFIG_ACPI_CUSTOM_DSDT=y" >> ./.config
	echo 'CONFIG_ACPI_CUSTOM_DSDT_FILE="DSDT.hex"' >> ./.config
	cp $srcdir/DSDT.hex include/DSDT.hex
...
package_linux-toshiba() {
  pkgdesc="The Linux Kernel and modules customized for certain Toshiba laptops"
  groups=('base')
