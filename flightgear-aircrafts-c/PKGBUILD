...
pkgname=flightgear-aircrafts-c
pkgver=3.0
pkgrel=1
pkgdesc="Aircraft collection for Flightgear - Name beginning with letter C."
...
package() {
  ...
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/c*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/C*'	#get and unzip the aircrafts
