...
if [[ ${CARCH} = x86_64 ]]; then
    source=("https://storage.googleapis.com/dart-archive/channels/dev/release/45369/editor/darteditor-linux-x64.zip")
    md5sums=("f1162358f8aed96807bcca31a6b0b869")
else
    source=("https://storage.googleapis.com/dart-archive/channels/dev/release/45369/editor/darteditor-linux-ia32.zip")
    md5sums=("020377d442204a84e8727d11121f38e3")
fi
