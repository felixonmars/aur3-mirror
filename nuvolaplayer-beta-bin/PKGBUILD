...
source_x86_64=("$_rpmurl/nuvolaplayer3-$pkgver-1.fc21.x86_64.rpm")
md5sums_i686=('35c14e24e31a1aef0355f33258f9e4a3')
source_i686=("$_rpmurl_32/nuvolaplayer3-$pkgver-1.fc21.i686.rpm")
...
source=("$_rpmurl/nuvolaplayer3-bandcamp-2.0-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-deezer-2.3-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-google-play-music-5.2-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-jango-2.0-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-kexp-1.0-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-mixcloud-1.0-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-rdio-4.0-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-spotify-2.0-1.fc21.x86_64.rpm"
        "$_rpmurl/nuvolaplayer3-this-is-my-jam-2.0-1.fc21.x86_64.rpm")
package() {
  rpmextract.sh *
  chmod -R g-w usr
