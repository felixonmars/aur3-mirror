...
pkgname=banshee-community-extensions.awn
...
license=('GPL2')
groups=()
depends=('mono' 'webkit-sharp' 'sqlite3' 'intltool' 'banshee' 'avant-window-navigator')
makedepends=()
optdepends=()
provides=()
...
build() {
        ...
        ./configure --prefix=/usr --enable-release --disable-alarmclock --disable-ampache --disable-appindicator --enable-awn --disable-clutterflow --disable-coverwallpaper --disable-jamendo --disable-lastfmfingerprint --disable-lcd --disable-lirc --disable-liveradio --disable-lyrics --disable-magnatune --disable-mirage --disable-openvp --disable-radiostationfetcher --disable-randombylastfm --disable-streamrecorder --disable-karaoke --disable-telepathy --disable-zeitgeistdataprovider
        make
}
package() {
