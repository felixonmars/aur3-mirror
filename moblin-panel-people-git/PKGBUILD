...
pkgname=moblin-panel-people-git
_pkgname=moblin-panel-people
pkgver=20090905
pkgrel=1
pkgdesc="A panel for instant messaging"
arch=('i686' 'x86_64')
url="http://www.moblin.org"
license=('GPL')
depends=('mutter-moblin-git' 'libccss-old' 'telepathy-mission-control')
makedepends=('git')
provides=($_pkgname)
conflicts=($_pkgname)
