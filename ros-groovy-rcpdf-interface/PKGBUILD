...
pkgdesc="ROS - Robot Contact Point Description Format interfaces definition."
url='http://www.ros.org/'

_name=rcpdf_interface
pkgname=ros-groovy-rcpdf-interface
pkgver=0.2
arch=('i686' 'x86_64')
pkgrel=1
license=('BSD')
