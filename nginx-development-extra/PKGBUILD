...
pkgname=nginx-development-extra
_pkgname=nginx
pkgver=1.4.1
pkgrel=4
pkgdesc="lightweight HTTP server - development release with debug enabled and easy external modules administration"
url="http://nginx.org"
license=('custom')
arch=('i686' 'x86_64')
provides=('nginx')
conflicts=('nginx' 'nginx-custom' 'nginx-unstable' 'nginx-svn' 'nginx-devel')
