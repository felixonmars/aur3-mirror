...
pkgname=haskell-xmobar-mpd
pkgver=0.19
pkgrel=1
pkgdesc="A Minimalistic Text Based Status Bar - with mpd support; synced with ArchHaskell"
url="http://hackage.haskell.org/package/xmobar"
license=('custom:BSD3')
arch=('i686' 'x86_64')
depends=('gmp' 'libxft' 'libxinerama' 'wireless_tools' 'libxrandr')
makedepends=('ghc=7.6.3-1' 'haskell-x11=1.6.1.1-5' 'haskell-x11-xft=0.3.1-31' 'haskell-utf8-string=0.3.7-27'
	     'haskell-stm=2.4.2-2' 'haskell-parsec=3.1.5-1' 'haskell-mtl=2.1.2-27' 'haskell-regex-base' 'haskell-regex-compat'
