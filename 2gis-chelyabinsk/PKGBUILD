...
pkgver=71
pkgrel=1
pkgdesc="Map of Chelyabinsk for 2GIS, July 2013"
arch=('i686' 'x86_64')
url="http://chelyabinsk.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.5.1')
source=("http://download.2gis.ru/arhives/2GISData_Chelyabinsk-71.orig.zip")
md5sums=('8fe7c6a312d11ae12d7db02c67777485')
