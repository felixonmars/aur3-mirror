...
pkgver=0.9.1
pkgrel=1
pkgdesc="C (glib2) bindings for Thrift, a scalable cross-language services framework for IPC/RPC"
arch=(i686 x86_64)
url="http://thrift.apache.org/"
license=(APACHE)
depends=(zlib libevent openssl glib2)
...
build() {
  ...
  ./configure --prefix=/usr --bindir=/dev/null \
    --without-cpp \
    --without-qt4 \
    --with-c_glib \
    --without-csharp \
