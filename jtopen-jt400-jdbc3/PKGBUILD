...
pkgname=jtopen-jt400-jdbc3
pkgver=8.1
pkgrel=1
pkgdesc="A reduced package for JTOpen, providing only the JT400 library with JDBC 3.0 driver for IBM AS/400 and iSeries data and resources"
arch=(any)
