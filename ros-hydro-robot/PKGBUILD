...
pkgdesc="ROS - robot metapackage."
url='http://www.ros.org/'

pkgname='ros-hydro-robot'
pkgver='1.0.2'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
ros_depends=(ros-hydro-geometry
  ros-hydro-common-msgs
  ros-hydro-driver-common
  ros-hydro-bond-core
  ros-hydro-executive-smach
  ros-hydro-diagnostics
...
_tag=release/hydro/robot/${pkgver}-${_pkgver_patch}
_dir=robot
