...
depends=(dosbox bash)
makedepends=(unrar)
source=('http://oldgames.ru:8080/oldgames/files/D/Dune_2.rar'
	'http://oldgames.ru:8080/oldgames/files/D/Dune_2_RUS.rar')
