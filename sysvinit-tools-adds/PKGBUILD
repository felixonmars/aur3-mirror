...
pkgname=sysvinit-tools-adds
pkgdesc="Linux System V Init Tools (except those which are in procps-ng)"
pkgver=2.88
pkgrel=12
arch=('i686' 'x86_64')
...
package() {
  ...
  # manpages
  install -m644 man/{bootlogd,killall5,fstab-decode}.8 "$pkgdir/usr/share/man/man8"
}
