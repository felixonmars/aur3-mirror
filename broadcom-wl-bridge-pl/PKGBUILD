...
pkgver=6.30.223.248
pkgrel=9
_pkgdesc='Broadcom 802.11abgn hybrid Linux networking device driver for linux-bridge-pl.'
...
install=broadcom-wl-bridge-pl.install
...
package() {
	...
	install -Dm644 modprobe.d "${pkgdir}/usr/lib/modprobe.d/broadcom-wl_bridge-pl.conf"
}
