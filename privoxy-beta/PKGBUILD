...
source=(http://downloads.sourceforge.net/sourceforge/ijbswa/privoxy-$pkgver-beta-src.tar.gz privoxy \
        privoxy.logrotated \
        privoxy.confd)
...
build() {
  GROUP_ID=42
  cd $startdir/src/privoxy-$pkgver-beta
  autoheader && autoconf
...
md5sums=('10d68175f12ca354bb099b09b682c768'
         '3c0f0c3ce941d74f40ddf0f858f7ba8d'
         'a364c34c8dc6eb78c9a6b777237932de'
         'c27cf5aaf0cf89825fd0f7a5a4ebd7c0')
