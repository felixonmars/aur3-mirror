  ...
  grunt.initConfig({
    ...
    nodewebkit: {
      build: {
        options: {
          ...
          mac_icns: './images/flixtor-ico.icns', // Path to the Mac icon file
    ...
    copy: {
      ...
      package: {
        files: [
          {
            src: 'build/releases/Flixtor/Flixtor.nw',
            dest: 'build/releases/Flixtor/linux32/Flixtor/package.nw',
            flatten: true
          },
          {
            src: 'build/releases/Flixtor/Flixtor.nw',
            dest: 'build/releases/Flixtor/linux64/Flixtor/package.nw',
            flatten: true
          }
        ]
      }
