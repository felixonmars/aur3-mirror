...
# Maintainer: Heli Villarreal <acmzero@gmail.com>

pkgbase=openbravo-postgresql
pkgname=('openbravo-postgresql-libs' 'openbravo-postgresql-docs' 'openbravo-postgresql')
pkgver=9.3.4
_majorver=${pkgver%.*}
pkgrel=2
arch=('i686' 'x86_64')
...
package_openbravo-postgresql-libs() {
  pkgdesc="Libraries for use with PostgreSQL"
  depends=('krb5' 'openssl>=1.0.0' 'readline>=6.0' 'uuid')
...
package_openbravo-postgresql-docs() {
