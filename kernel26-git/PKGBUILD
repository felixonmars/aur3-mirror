...
md5sums=('d3b8649fbd49b94100a78f27c0fb90c9'
         'a86eb819d7f446edd233c1818ccc99dc')
sha256sums=('e562fe81a334b381f38840675b2aa5f2733ae3cedb68d294dff2a904f0ca060f'
            '126e4255a2996d8b3d73927f018f694d4c1255126015fe86a6e0a9e231fda4fb')
...
build() {
	if [[ -n $_gitname && -n $_gitroot ]]; then
		...
		if [[ -d $_gitname ]]; then
			...
			warning "The initial clone will download approximately 400 mb"
