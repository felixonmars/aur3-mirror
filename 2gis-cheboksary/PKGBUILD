...
pkgver=33
pkgrel=1
pkgdesc="Map of Cheboksary for 2GIS, July 2014"
arch=('i686' 'x86_64')
url="http://info.2gis.ru/cheboksary/products/download#linux"
license=('custom')
depends=('2gis>=3.14.7.0')
source=("http://download.2gis.com/arhives/2GISData_Cheboksary-33.orig.zip")
md5sums=('f8dbd23785561891fcd54ef1416620e6')
