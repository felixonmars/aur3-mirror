...
pkgver=84
pkgrel=2
pkgdesc="Map of Nizhnevartovsk for 2GIS, May 2013"
arch=('i686' 'x86_64')
url="http://nizhnevartovsk.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.5.1')
source=("http://download.2gis.ru/arhives/2GISData_Nizhnevartovsk-84.orig.zip")
md5sums=('fe8face4f26387ad1d01a83d015ff898')
