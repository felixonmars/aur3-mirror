...
pkgver=85
pkgrel=1
pkgdesc="Map of Nizhnevartovsk for 2GIS, June 2013"
arch=('i686' 'x86_64')
url="http://nizhnevartovsk.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.13.5.1')
source=("http://download.2gis.ru/arhives/2GISData_Nizhnevartovsk-85.orig.zip")
md5sums=('97d7c57f28ba4d0ef62aa1d2fd214fcb')
