...
sha1sums=('ee142be03db09290b4adcdf1d412ee1850acd1e9'
          ...
          'b3a3c96b177ebec9c3ce909afcfea34c65dc4fb8'
          'SKIP')

pkgdesc="Wine with Wolfenstein New Order Patch (for Nvidia users) + Maarten Lankhorst's multimedia patches, including PulseAudio support "
...
prepare() {
  ...
  msg2 "Applying Wolfenstein New Order patch"
  patch -Np1 -i "${srcdir}"/wolf.patch
}
