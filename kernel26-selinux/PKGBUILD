...
# Contributor: Ng Oon-Ee (ng oon ee <at>  gmail <dot> com)
pkgbase="kernel26-selinux"
pkgname=('kernel26-selinux')
true && pkgname=('kernel26-selinux' 'kernel26-selinux-headers')
...
package_kernel26-selinux() {
  pkgdesc="The SELinux enabled Linux Kernel and modules"
  groups=('selinux' 'selinux-system-utilities')
  backup=(etc/mkinitcpio.d/${pkgname}.preset)
  depends=('selinux-coreutils' 'linux-firmware' 'module-init-tools>=3.12-2' 'mkinitcpio>=0.6.8-2')
...
package_kernel26-selinux-headers() {
  pkgdesc="Header files and scripts for building modules for kernel26-selinux"
  groups=('selinux' 'selinux-system-utilities')
