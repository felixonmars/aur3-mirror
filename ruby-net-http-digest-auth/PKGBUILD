...
_ruby="/usr/bin/ruby"
_gem="/usr/bin/gem"
pkgname="ruby-net-http-digest-auth"
pkgver="1.2.1"
pkgrel=1
...
depends=("ruby")
conflicts=()
optdepends=("ruby-minitest: minitest provides a complete suite of testing facilities supporting TDD, BDD, mo..."
            "ruby-rdoc: RDoc produces HTML and command-line documentation for Ruby projects"
            "ruby-hoe: Hoe is a rake/rubygems helper for project Rakefiles")
source=("http://rubygems.org/gems/$_gemname-$pkgver.gem")
sha256sums=("407946048fdb8f994308ccf8bc1f9f9e7e05e36cb4b04e0485a39964092f5fdf")
