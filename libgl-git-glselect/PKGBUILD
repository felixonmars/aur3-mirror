pkgname=('libgl-git-glselect')
pkgver=20100321
pkgrel=1
pkgdesc="Mesa 3-D graphics library and DRI software rasterizer from the git master branch with nvidia*-utils compatibility."
arch=(i686 x86_64)
license=('custom')
url="http://mesa3d.sourceforge.net"
depends=('libdrm-git' 'libxxf86vm>=1.1.0' 'libxdamage>=1.1.2')
