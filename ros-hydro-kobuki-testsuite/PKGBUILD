...
pkgdesc="ROS - Kobuki test suite: this package provides tools to thoroughly test Kobukis hardware."
url='http://ros.org/wiki/kobuki_testsuite'

pkgname='ros-hydro-kobuki-testsuite'
pkgver='0.5.6'
_pkgver_patch=0
arch=('any')
pkgrel=1
...
_tag=release/hydro/kobuki_testsuite/${pkgver}-${_pkgver_patch}
