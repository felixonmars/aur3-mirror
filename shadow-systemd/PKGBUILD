...
pkgname=shadow-systemd
pkgver=4.1.5.1
pkgrel=7
pkgdesc="Password and account management tool suite with support for shadow files and PAM (with systemd support)"
arch=('i686' 'x86_64')
...
source=("http://pkg-shadow.alioth.debian.org/releases/shadow-$pkgver.tar.bz2"{,.sig}
        LICENSE
        chgpasswd
        chpasswd
        defaults.pam
...
sha1sums=('81f38720b953ef9c2c100c43d02dfe19cafd6c30'
          ...
          'dfb4e0381ac45a77b6260a8bf1b1302d61ec84e7'
...
package() {
  ...
  # service unit
  install -Dm644 "$srcdir/verify-shadow.service" "$pkgdir/usr/lib/systemd/system/verify-shadow.service"
