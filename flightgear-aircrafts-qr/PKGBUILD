...
pkgname=flightgear-aircrafts-qr
pkgver=3.0
pkgrel=1
pkgdesc="Aircraft collection for Flightgear - Name beginning with letter Q and R."
...
package() {
  ...
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/q*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/Q*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/r*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/R*'	#get and unzip the aircrafts
