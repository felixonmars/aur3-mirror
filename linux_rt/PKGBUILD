...
_basekernel=3.0
_rtpatch=rt12
pkgver=${_basekernel}.3_$_rtpatch
_pkgver=${_basekernel}.3
pkgrel=1
arch=('i686' 'x86_64')
...
provides=('kernel26rt')
conflicts=('kernel26rt')
replaces=('kernel26rt')
install=${pkgname}.install
source=("ftp://ftp.kernel.org/pub/linux/kernel/v3.0/linux-${_basekernel}.tar.bz2"
        "ftp://ftp.kernel.org/pub/linux/kernel/v3.0/patch-${_pkgver}.bz2"
        "ftp://ftp.kernel.org/pub/linux/kernel/projects/rt/patch-${_pkgver}-${_rtpatch}.patch.bz2"
...
md5sums=('398e95866794def22b12dfbc15ce89c0'
         ...
         '2236fc6bae8e41979094a41e66fa9eb5'
         'a17454195361a0b3b21ad9aebe51e299'
         'fc4e963c403e897f65e8e18a6a7783c5'
...
build() {
  ...
  # add realtime patch
  patch -p1 -i "${srcdir}/patch-${_pkgver}-$_rtpatch.patch"
