...
pkgname=moblin-web-browser-git
_pkgname=moblin-web-browser
pkgver=20090905
pkgrel=1
pkgdesc="A tightly-integrated web browser for moblin"
arch=('i686' 'x86_64')
url="http://www.moblin.org"
license=('GPL')
depends=('clutter-mozembed-git' 'nbtk-git' 'libunique' 'startup-notification')
makedepends=('git')
provides=($_pkgname)
conflicts=($_pkgname)
