...
#
# This was in community, but was dropped due to old age.
...
source=(http://downloads.sourceforge.net/sourceforge/cube/${pkgname}_${pkgver}_unix.tar.gz \
        ...
        cube.xpm cube.desktop cube.sh cubed.sh LICENSE cube_source-aur.patch)
md5sums=('e77f3cf85292bf61100d2f8511a254cc'
         'e376c49ac209b095cb6d29490834d060'
         'd8c1368a2ac729e168fe3dac7e7bd284'
         'a09afc0facfb3f048bcc4d9377af3189'
         '6a2fb52692891df61fc8d240869a5b2e'
         'a5f6262cc6274f1a5c244ea0999d13de'
         'f4d9ce2d2b79983f1ef221929cd86a5f'
         'efe6665d991f1de1b184623795451d02')
...
# Arch-specific patches
  cd $srcdir
  patch -Np0 < cube_source-aur.patch
