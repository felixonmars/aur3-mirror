...
pkgver="1.1.3"
pkgrel=1
pkgdesc="LPR and CUPS driver for the Brother MFC-250CW"
...
source=(
	"http://www.brother.com/pub/bsc/linux/dlf/mfc255cwlpr-$pkgver-$pkgrel.i386.rpm"
	"http://www.brother.com/pub/bsc/linux/dlf/mfc255cwcupswrapper-$pkgver-$pkgrel.i386.rpm"
	'cupswrapper-license.txt'
	'lpr-license.txt'
)
md5sums=(
	'e36d4a5cebc93b95e2699e82737b25b3'
