...
pkgname=kernel26-helium0       # Build kernel with a different name
...
source=(http://www.kernel.org/pub/linux/kernel/v2.6/linux-$_basekernel.tar.bz2
        ...
        kernel26.preset
	http://hirakendu.mooo.com/helium-sources/${_patchname}/${_patchname}.patch.bz2)
...
build() {
  ...
  bzip2 -dc ${_patchname}.patch.bz2 | patch -Np1 -i ${srcdir}/${_patchname}.patch
...
md5sums=('1aab7a741abe08d42e8eccf20de61e05'
         ...
         '464e3111b386a10c6cd7e7be0a655832'
         '37bdb82ae308b9f31815c1df5eeee764')
