...
depends=('gnome-python' 'python2-notify' 'python2-pybluez' 'bluez4>=4.21' 'dbus-python' 'gnome-python'
	'gtk2>=2.12' 'glib2>=2.12' 'pygobject>=2.12' 'intltool' 'gconf>=2.0'
...
package() {
  ...
  # 'Patch' for python2
  cd $pkgdir/usr
  for i in bin/blueman-* libexec/* ; do
