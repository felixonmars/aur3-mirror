...
pkgver=1.0
pkgrel=3
pkgdesc="A free Zelda fan game that looks like old Zelda games - demo version with the beginning of the game."
arch=('i686' 'x86_64')
...
build() {
  ...
  cp -R $srcdir/zsdxdemo/languages/en/* $srcdir/zsdxdemo/data
