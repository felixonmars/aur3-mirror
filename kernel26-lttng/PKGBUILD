...
# Based on package kernel26 by
#   Tobias Powalowski <tpowa@archlinux.org> and
#   Thomas Baechler <thomas@archlinux.org>

pkgname='kernel26-lttng'
_kernelname=${pkgname#kernel26}
_basekernel=2.6.39
_lttng=dev-snapshot-distro-20110511
...
source=(ftp://ftp.kernel.org/pub/linux/kernel/v2.6/linux-$_basekernel.tar.bz2
        ...
        kernel26.preset
        http://lttng.org/files/lttng/patch-${_basekernel}-rc5-lttng-${_lttng}.tar.bz2)
md5sums=('1aab7a741abe08d42e8eccf20de61e05'
         ...
         '7e082d1285a67a2c4b818275444c7450')

build() {
  cd ${srcdir}/linux-$_basekernel

  cp -r ${srcdir}/patch-${_basekernel}-rc5-lttng-${_lttng} patches
  quilt push -a
...
package_kernel26-lttng() {
  pkgdesc="Linux Kernel with LTTng patches"
  groups=('base')
