...
arch=('i686' 'x86_64')
makedepends=('ghc')
depends=('haskell-comonad' 'haskell-containers' 'haskell-contravariant' 'haskell-distributive' 'haskell-semigroups' 'haskell-transformers')
options=('staticlibs')
source=("http://hackage.haskell.org/packages/archive/${_hkgname}/${pkgver}/${_hkgname}-${pkgver}.tar.gz")
md5sums=('64ce34ede6090931977c5196dafc4ae3')
