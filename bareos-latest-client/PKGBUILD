...
package() {
  ...
  for file in  \
    ...
    ${_script_dir}/${_pkgname}-ctl-sd \
    ${_script_dir}/mtx-changer \
    ${_sysconf_dir}/mtx-changer.conf \
    ${_sbin_dir}/${_pkgname} \
    ${_man_dir}/man8/bareos-dir.8.gz \
    ${_man_dir}/man8/bareos-fd.8.gz \
    ${_man_dir}/man8/bcopy.8.gz \
    ${_man_dir}/man8/bextract.8.gz \
    ${_man_dir}/man8/bls.8.gz \
    ${_man_dir}/man8/bpluginfo.8.gz \
    ${_man_dir}/man8/bregex.8.gz \
    ${_man_dir}/man8/bscan.8.gz \
    ${_man_dir}/man8/bscrypto.8.gz \
    ${_man_dir}/man8/btape.8.gz \
    ${_man_dir}/man8/bwild.8.gz \
    ${_systemd_dir}/bareos-dir.service \
    ${_systemd_dir}/bareos-sd.service
  do
    rm -f "${pkgdir}/$file"
  done
