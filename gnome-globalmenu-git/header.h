/* header.h generated by valac 0.12.0, the Vala compiler, do not modify */
...
void menubar_superrider_get_preferred_width (GtkWidget* widget, gint* natural, gint* minimal);
void menubar_superrider_get_preferred_height (GtkWidget* widget, gint* natural, gint* minimal);
