...
pkgver="1.1.3"
pkgrel=1
pkgdesc="Command line tool that allows you to quickly cd to git projects and other handy things."
arch=("any")
url="http://github.com/trishume/pro"
license=("MIT")
...
depends=("ruby"
         ...
         "ruby-colored>=0")
conflicts=()
optdepends=("ruby-bundler: The best way to manage your application's dependencies"
            "ruby-rake: Ruby based make-like utility."
            "ruby-pry: An IRB alternative and runtime developer console")
source=("https://rubygems.org/gems/$_gemname-$pkgver.gem")
sha256sums=("298651a088c63b5eeda467f28dff853f41c024e136e729aca0ecdfb166ee6291")
