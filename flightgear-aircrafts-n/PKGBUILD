...
pkgname=flightgear-aircrafts-n
pkgver=3.0
pkgrel=1
pkgdesc="Aircraft collection for Flightgear - Name beginning with letter N."
...
package() {
  ...
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/n*'	#get and unzip the aircrafts
  wget --retry-connrefused 'ftp://'$_FTP_HOST'/'$_FTP_DIR'/N*'	#get and unzip the aircrafts
