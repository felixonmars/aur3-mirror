...
pkgname=openoffice-base-bin-de
replaces=('openoffice-base-bin')
pkgver=4.1.0
pkgrel=1
pkgdesc="OpenOffice - German version"
arch=('i686' 'x86_64')
...
in i686 )
	...
	sha256sums[0]='0478444a69408a6b4cf7b7e6c621792384b11e2ddee4317571379d881dd63c35'
;; x86_64 )
	source[0]+="Apache_OpenOffice_${pkgver}_Linux_x86-64_install-rpm_${_lang}.tar.gz"
	sha256sums[0]='7f95d8d902c83a8431319d71d1d235c7cb21e4e60d81bc18d3629d9cecd10c66'
esac
