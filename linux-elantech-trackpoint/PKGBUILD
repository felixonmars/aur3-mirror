...
pkgname=linux-elantech-trackpoint
pkgbase=linux-elantech-trackpoint       # Build kernel with a different name
_srcname=linux-3.12
pkgver=3.12.1
pkgrel=1
arch=('i686' 'x86_64')
...
prepare() {
  ...
  # apply trackpoint split patch
  patch -Np1 -i "${srcdir}/elantechfull.patch"
...
_package() {
  pkgdesc="The Linux kernel and modules with split-patch for the elantech trackpoint/touchpad from the linux-input mailing list for ThinkPad L430/L530 "
...
md5sums=('cc6ee608854e0da4b64f6c1ff8b6398c'
         ...
         '98beb36f9b8cf16e58de2483ea9985e3'
         'd50c1ac47394e9aec637002ef3392bd1'
         '71ec30b5ceb09f9a9268e851d7710bef')
