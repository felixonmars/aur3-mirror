...
pkgver=114
pkgrel=1
pkgdesc="Map of Barnaul for 2GIS, August 2014"
arch=('i686' 'x86_64')
url="http://info.2gis.ru/barnaul/products/download#linux"
license=('custom')
depends=('2gis>=3.14.7.0')
source=("http://download.2gis.com/arhives/2GISData_Barnaul-114.orig.zip")
md5sums=('0f10831c1813b8afbc2c24e253f0c04c')
