...
set(qt_mkspecs_dirs ${WPS_QMAKE_MKSPECS})
...
set(QT_LIBRARY_DIR_TMP ${WPS_QT_INSTALL_LIBS})
...
set(QT_BINARY_DIR ${WPS_QT_INSTALL_BINS} CACHE INTERNAL "" FORCE)

set(qt_headers ${WPS_QT_INSTALL_HEADERS})
...
set(qt_doc_dir ${WPS_QT_INSTALL_DOCS})
set(QT_DOC_DIR ${qt_doc_dir} CACHE PATH "The location of the Qt docs" FORCE)

set(qt_plugins_dir ${WPS_QT_INSTALL_PLUGINS})
...
set(QT_TRANSLATIONS_DIR ${WPS_QT_INSTALL_TRANSLATIONS} CACHE PATH "The location of the Qt translations" FORCE)

set(qt_imports_dir ${WPS_QT_INSTALL_IMPORTS})
if(qt_imports_dir)
