...
# This is the same of gcc-4.4-multilib, it just compiles and has static libraries... just this :P

pkgname='gcc44-multilib-android'
pkgver=4.4.7
pkgrel=3
_libstdcppmanver=4.5.2		# Note: check source directory name when updating this
pkgdesc="The GNU Compiler Collection, version 4.4.7 - multilib version - built for Android developing - Read PKGBUILD for further infos"
arch=('i686' 'x86_64')
