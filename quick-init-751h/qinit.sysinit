...
#UVESAFB must be compiled as a module in the kernel, and the patcher must be run before loading the module uvesafb
/usr/sbin/915resolution 5c 1366 768 > /dev/null
