...
options=('force')
install=xpdf-openmotif.install
source=(ftp://ftp.foolabs.com/pub/${_pkgname}/${_pkgname}-${_srcver}.tar.gz
        ftp://ftp.foolabs.com/pub/${_pkgname}/${_pkgname}-${_srcver}pl1.patch
        ftp://ftp.foolabs.com/pub/${_pkgname}/${_pkgname}-${_srcver}pl2.patch
        ftp://ftp.foolabs.com/pub/${_pkgname}/${_pkgname}-${_srcver}pl3.patch
        ftp://ftp.foolabs.com/pub/${_pkgname}/${_pkgname}-${_srcver}pl4.patch
        ftp://ftp.foolabs.com/pub/${_pkgname}/${_pkgname}-${_srcver}${_patchlevel}.patch
...
build() {
  ...
  patch -Np1 -i "${srcdir}/${_pkgname}-${_srcver}pl1.patch" || return 1
  patch -Np1 -i "${srcdir}/${_pkgname}-${_srcver}pl2.patch" || return 1
  patch -Np1 -i "${srcdir}/${_pkgname}-${_srcver}pl3.patch" || return 1
  patch -Np1 -i "${srcdir}/${_pkgname}-${_srcver}${_patchlevel}.patch" || return 1
