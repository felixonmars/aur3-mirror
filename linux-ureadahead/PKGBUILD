...
md5sums=('a8e65f43d6afd10feb8c1f50b559a84e'
        'cf423754646d150bdc55600939c36323'
        '1baf375c01aec5a6d07ab9d176421d0c'
        'b905401b24aa6f1d3665543cd7d081e5'
...
package_linux-ureadahead() {
  pkgdesc="The Linux Kernel and modules patched with support for ureadahead"
  depends=('coreutils' 'linux-firmware' 'module-init-tools>=3.16' 'mkinitcpio>=0.7')
  optdepends=('crda: to set the correct wireless channels of your country')
  provides=('kernel26-yi')
  conflicts=('kernel26-yi')
  replaces=('kernel26-yi')
...
package_linux-ureadahead-headers() {
