...
_ruby="/usr/bin/ruby"
_gem="/usr/bin/gem"
pkgname="ruby-gtk-webkit-ruby"
pkgver="0.0.5"
pkgrel=1
pkgdesc="Webkit bindings using rubber-generate"
arch=("i686"
      "x86_64")
url="http://github.com/geoffyoungs/gtk-webkit-ruby"
license=("RUBY")
_licensefile=()
groups=("pacgem")
makedepends=("ruby"
             "binutils")
depends=("ruby"
         "ruby-rubber-generate>=0.0.17"
         "libffi")
conflicts=()
optdepends=()
source=("http://rubygems.org/gems/$_gemname-$pkgver.gem")
sha256sums=("3b3e01106daf3878f65c73e17ef154f8489a46139a2f3d4c6aa45258e54e474a")
