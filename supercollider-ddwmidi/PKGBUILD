...
pkgname=supercollider-ddwmidi
pkgdesc="SuperCollider quark: A MIDI response framework. Used optionally by Voicers, Mixers and chucklib. Author: James Harkins."
_quark="ddwMIDI"
_path=dewdrop_lib/ddwMIDI
