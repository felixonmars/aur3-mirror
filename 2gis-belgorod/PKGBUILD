...
pkgver=18
pkgrel=1
pkgdesc="Map of Belgorod for 2GIS, December 2012"
arch=('i686' 'x86_64')
url="http://belgorod.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.12.0.2')
source=("http://download.2gis.ru/arhives/2GISData_Belgorod-18.orig.zip")
md5sums=('542e8de69e49b98e6d6ac82b9cdbe689')
