...
pkgver=19
pkgrel=1
pkgdesc="Map of Belgorod for 2GIS, January 2013"
arch=('i686' 'x86_64')
url="http://belgorod.2gis.ru/how-get/linux/"
license=('custom')
depends=('2gis>=3.12.0.2')
source=("http://download.2gis.ru/arhives/2GISData_Belgorod-19.orig.zip")
md5sums=('9bb28d1516840b9f022b322b10e35435')
