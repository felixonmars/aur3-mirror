# Maintainer: Ari Selseng <ari@selseng.net>
# Based on linux-mainline (aur)
#pkgbase="linux"
#pkgname=('linux' 'linux-headers' 'linux-docs') # Build stock -ARCH kernel
pkgname=linux-mainline-ux31e       # Build kernel with a different name
...
md5sums=('ee75a1c2343cb0c8d60da6b891bf7902'
         '64d8c380e062bc92d092bbd7949f4dfa'
         'd3843ea479d5c270a553d320da8ff576'
         'eb14dcfd80c00852ef81ded6e826826a'
         '9d3c56a4b999c8bfbd4018089a62f662'
         '263725f20c0b9eb9c353040792d644e5'
         '4cd79aa147825837dc8bc9f6b736c0a0'
         '80642a61c2595f358a1c5879a8b9bad6'
         '5dc8094110f03c869c73d5eaa46362e2'
         'a460b0b1cf6e1c0c34103d0ef4e817ea')
build() {
  cd "${srcdir}/linux-${_basekernel}"

  # Asus Zenbook patches
  patch -Np1 -i "${srcdir}/bluetooth.patch"
  # sentelic touchpad - Fixed in 3.2
  cp "${srcdir}"/sentelic.* "${srcdir}/linux-${_basekernel}/drivers/input/mouse/"
...
package_linux() {
  pkgdesc="Mainline kernel for Asus Zenbook UX31e. Also works for UX21E. Intel RC6 fix and ath9k fix is now included upstream. This kernel fixes bluetooth and sentelic touchpads."
  #groups=('base')
