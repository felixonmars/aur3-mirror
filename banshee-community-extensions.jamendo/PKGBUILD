...
pkgname=banshee-community-extensions.jamendo
...
build() {
        ...
        ./configure --prefix=/usr --enable-release --disable-alarmclock --disable-ampache --disable-appindicator --disable-awn --disable-clutterflow --disable-coverwallpaper --enable-jamendo --disable-lastfmfingerprint --disable-lcd --disable-lirc --disable-liveradio --disable-lyrics --disable-magnatune --disable-mirage --disable-openvp --disable-radiostationfetcher --disable-randombylastfm --disable-streamrecorder --disable-karaoke --disable-telepathy --disable-zeitgeistdataprovider
        make
}
package() {
