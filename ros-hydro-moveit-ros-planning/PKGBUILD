...
pkgname='ros-hydro-moveit-ros-planning'
pkgver='0.5.16'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
ros_makedepends=(ros-hydro-angles
...
_tag=release/hydro/moveit_ros_planning/${pkgver}-${_pkgver_patch}
