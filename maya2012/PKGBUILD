...
source=(http://images.autodesk.com/adsk/files/autodesk_maya_2012_english_linux_64bit2.tgz
	ljpeg6_preload.patch)
sha1sums=('c204619ed70313219a240a58b8fbcddc6fad3fbc'
	'e254411a94ba87f5721caf5a01cd3bdbfdb04e49')
options=('!strip')
install=maya2012.install

build() {
  cd ${pkgdir}
  rpmextract.sh ${srcdir}/adlmapps4-4.0.35-0.x86_64.rpm
  rpmextract.sh ${srcdir}/adlmflexnetclient-4.0.35-0.x86_64.rpm
  rpmextract.sh ${srcdir}/Maya2012_0_64-2012.0-499.x86_64.rpm
...
package() {
  ...
  ln -sf /usr/autodesk/maya2012-x64/bin/maya2012 ${pkgdir}/usr/bin/maya
  ln -sf /usr/autodesk/maya2012-x64/bin/Render ${pkgdir}/usr/bin/Render
  ln -sf /usr/autodesk/maya2012-x64/bin/fcheck ${pkgdir}/usr/bin/fcheck
  ln -sf /usr/autodesk/maya2012-x64/bin/imgcvt ${pkgdir}/usr/bin/imgcvt
  ...
  ln -sf /usr/autodesk/maya2012-x64/desktop/Autodesk-Maya.desktop ${pkgdir}/usr/share/applications/Autodesk-Maya2012-x64.desktop
  mkdir -p ${pkgdir}/usr/share/desktop-directories
  ln -sf /usr/autodesk/maya2012-x64/desktop/Autodesk-Maya.directory ${pkgdir}/usr/share/desktop-directories/Autodesk-Maya2012-x64.directory
  mkdir -p ${pkgdir}/usr/share/icons/hicolor/48x48/apps
  ln -sf /usr/autodesk/maya2012-x64/desktop/Maya.png ${pkgdir}/usr/share/icons/hicolor/48x48/apps/Maya2012.png
  ...
  then
    ln -s /usr/lib/libssl.so ${pkgdir}/usr/autodesk/maya2012-x64/lib/libssl.so.6 
    ln -s /usr/lib/libcrypto.so ${pkgdir}/usr/autodesk/maya2012-x64/lib/libcrypto.so.6
  fi
  ...
  sed -e "/__EXECUTABLE_PATH__/s//${RPM_INSTALL_PATH}.bin\"\n      StartWrapperPath=\"${RPM_INSTALL_PATH}2012/" ${pkgdir}/opt/Autodesk/Synergy/Maya2012.2012.1.64.syncfg > ${pkgdir}/opt/Autodesk/Synergy/maya2012tmp.txt
  mv ${pkgdir}/opt/Autodesk/Synergy/maya2012tmp.txt ${pkgdir}/opt/Autodesk/Synergy/Maya2012.2012.1.64.syncfg
