...
arch=('i686' 'x86_64')
url='http://docs.opennebula.org/4.12/'
license=('Apache')
depends=('ruby>=1.8.7'
         'xmlrpc-c>=1.31'
         'openssl>=0.9.8'
...
build() {
	...
	## http://docs.opennebula.org/4.12/integration/references/compile.html   ##
	##                                                                       ##
