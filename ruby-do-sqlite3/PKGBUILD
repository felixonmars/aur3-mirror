...
_ruby="/usr/bin/ruby"
_gem="/usr/bin/gem"
pkgname="ruby-do-sqlite3"
pkgver="0.10.12"
pkgrel=1
pkgdesc="DataObjects Sqlite3 Driver"
arch=("i686"
      "x86_64")
url=("http://rubygems.org/gems/do_sqlite3")
license=("RUBY")
_licensefile=()
groups=("pacgem")
makedepends=("ruby"
...
sha256sums=("fb6c9a06b792092fe71e8ed94387646c600247067281a73b19634addf13fb1a2")
