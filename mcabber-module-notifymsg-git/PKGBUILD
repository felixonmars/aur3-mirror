...
pkgname="mcabber-module-notifymsg-git"
pkgver=20101219
pkgrel=1
pkgdesc="A small module that notificates you(via LogWindow) when a new message recieved"
...
_gitroot="http://isbear.unixzone.org.ua/source/mcabber-notifymsg"
_gitname="mcabber-notifymsg"
