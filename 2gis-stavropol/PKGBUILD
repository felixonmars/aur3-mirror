...
pkgver=33
pkgrel=1
pkgdesc="Map of Stavropol for 2GIS, September 2014"
arch=('i686' 'x86_64')
url="http://info.2gis.ru/stavropol/products/download#linux"
license=('custom')
depends=('2gis>=3.14.7.0')
source=("http://download.2gis.com/arhives/2GISData_Stavropol-33.orig.zip")
md5sums=('1bd8aafabff0758ba21e2c59fb41a59b')
