...
#changelog
source=("$pkgname-$pkgver.tar.gz::https://github.com/gitlabhq/gitlab-ci-runner/archive/${pkgver}-0-stable.tar.gz"
	gitlab-ci-runner.service
	gitlab-ci-runner.install
)
#noextract
sha512sums=('d14e72d7a58e121b5f56b6f8711f859723e45195bd9e6ddb360052934cf82b0c4f764f6c0dc12a29b50db24a8a2329bd86ed4c8888537be316cef715253f943d'
...
package() {
    ...
    cd "$srcdir/gitlab-ci-runner-$pkgver-0-stable"
