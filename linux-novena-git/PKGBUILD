...
pkgbase=linux-novena-git
_srcname=novena-linux
_kernelname=${pkgbase#linux}
_desc="i.MX6 Novena"
pkgver=3.19.novena.r17.r0.g4061eff
pkgrel=1
arch=('armv7h')
url="https://github.com/xobs/novena-linux/"
license=('GPL2')
makedepends=('xmlto' 'docbook-xsl' 'kmod' 'inetutils' 'bc' 'git')
options=('!strip')
source=("git+https://github.com/xobs/novena-linux.git#tag=3.19-novena-r17")
md5sums=('SKIP')
...
prepare() {
  ...
  cat "arch/arm/configs/novena_defconfig" > ./.config
...
build() {
  ...
  make ${MAKEFLAGS} zImage modules imx6q-novena.dtb
}
...
_package() {
  ...
  cp arch/$KARCH/boot/dts/imx6q-novena.dtb "${pkgdir}/boot/novena.dtb"
...
_package-headers() {
  ...
  replaces=('linux-imx6-novena-dt-headers')
