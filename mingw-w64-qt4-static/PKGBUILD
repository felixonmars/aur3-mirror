...
depends=(
  ...
  'mingw-w64-openssl'
  'mingw-w64-libdbus')
makedepends=('mingw-w64-gcc' 'mingw-w64-libmariadbclient' 'mingw-w64-postgresql-libs' 'mingw-w64-pkg-config')
...
source=("http://download.qt-project.org/official_releases/qt/4.8/${pkgver}/${_pkgfqn}.tar.gz"
        ...
        'qt-4.8.6-fix-out-of-tree-compilation.patch'
...
md5sums=('2edbe4d6c2eff33ef91732602f3518eb'
         ...
         '3f5cd9f0b5867c6eaf07f81b4e827c33'
         '38aa00cf498e7df8807785ee6bcbe8fc'
...
prepare() {
  ...
  patch -Np1 -i "${srcdir}"/qt-everywhere-opensource-src-4.8.6-QTBUG-38367.patch

  # Fix out of tree compilation
  patch -Np1 -i "${srcdir}"/qt-4.8.6-fix-out-of-tree-compilation.patch
