...
source=('http://download.neorouter.com/Downloads/NRFree/Update_2.1.2.4326/Linux/CentOS/nrclient-2.1.2.4326-free-centos-i386.rpm' 'nrclient.service')
md5sums=('2696920a2a1088a879813c70a651f1e6'
'051c0ba7598249e035368f8ecb6ea44d')
if test "$CARCH" == x86_64; then
source=('http://download.neorouter.com/Downloads/NRFree/Update_2.1.2.4326/Linux/CentOS/nrclient-2.1.2.4326-free-centos-x86_64.rpm' 'nrclient.service')
...
i686)
cd $srcdir/
rpmextract.sh $startdir/src/nrclient-2.1.2.4326-free-centos-i386.rpm
rm $startdir/src/nrclient-2.1.2.4326-free-centos-i386.rpm
;;
x86_64)
cd $srcdir/
rpmextract.sh $startdir/src/nrclient-2.1.2.4326-free-centos-x86_64.rpm
rm $startdir/src/nrclient-2.1.2.4326-free-centos-x86_64.rpm
;;
esac
}
