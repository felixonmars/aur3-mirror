...
pkgname=qt-kinetic-bauhaus-git
pkgver=20091109
pkgrel=3
pkgdesc="The QT gui toolkit. Development project kinetic, branch Bauhaus, with new animation framework, amazing declarative UI and more new features. Installs in /opt"
arch=('i686' 'x86_64')
...
build() {
	...
	./configure -prefix /opt/qt-kinetic-bauhaus-git || return 1
	make || return 1
