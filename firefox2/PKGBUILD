...
pkgver=2.0.0.16
pkgrel=1
pkgdesc="Mozilla Firefox 2 Updated - Based on Arch Linux last official release of Firefox 2 (Apr 18 2008)"
arch=(i686 x86_64)
...
source=(ftp://ftp.mozilla.org/pub/mozilla.org/${_pkgname}/releases/${pkgver}/source/${_pkgname}-${pkgver}-source.tar.bz2
        mozconfig
       	launcher.patch
...
md5sums=('90e0b7996a14fdbe6d4e6e4d87980647'
