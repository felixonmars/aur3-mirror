...
changelog=Changelog
source=(http://www.yourkit.com/download/yjp-${_version}-eap-build-${_build}-linux.tar.bz2)
md5sums=('e2881026ea599e6fb95320d5ec202adc')
...
package() {
  ...
  cp -a "${srcdir}"/yjp-${_version}-eap-build-${_build}/* "${pkgdir}/opt/${pkgname}"
