pkgname=lazarus-svn-qt
pkgver=43198
pkgrel=1
pkgdesc="IDE for FreePascal (Development version, QT)"
arch=('i686' 'x86_64')
url="http://www.lazarus.freepascal.org/"
license=('GPL2' 'MPL' 'custom:LGPL')
depends=('fpc' 'fpc-src' 'gdk-pixbuf' 'qt4pas' 'qtwebkit')
...
build() {
  ...
  make FPC=/usr/bin/fpc LCL_PLATFORM=qt clean all || return 1
