...
pkgdesc="ROS - Main loop that runs the robot."
url='http://www.ros.org/'

pkgname='ros-hydro-pr2-ethercat'
pkgver='1.6.6'
_pkgver_patch=0
arch=('i686' 'x86_64')
pkgrel=1
...
ros_depends=(ros-hydro-ethercat-hardware
...
_tag=release/hydro/pr2_ethercat/${pkgver}-${_pkgver_patch}
_dir=pr2_ethercat
