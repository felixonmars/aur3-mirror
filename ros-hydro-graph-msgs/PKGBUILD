...
_tag=release/hydro/graph_msgs/${pkgver}-${_pkgver_patch}
_dir=graph_msgs
source=("${_dir}"::"git+https://github.com/davetcoleman/graph_msgs-release.git"#tag=${_tag})
md5sums=('SKIP')
