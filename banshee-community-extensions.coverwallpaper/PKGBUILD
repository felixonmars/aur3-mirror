...
pkgname=banshee-community-extensions.coverwallpaper
...
build() {
        ...
        ./configure --prefix=/usr --enable-release --disable-alarmclock --disable-ampache --disable-appindicator --disable-awn --disable-clutterflow --enable-coverwallpaper --disable-jamendo --disable-lastfmfingerprint --disable-lcd --disable-lirc --disable-liveradio --disable-lyrics --disable-magnatune --disable-mirage --disable-openvp --disable-radiostationfetcher --disable-randombylastfm --disable-streamrecorder --disable-karaoke --disable-telepathy --disable-zeitgeistdataprovider
        make
}
package() {
